<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCIncome.ascx.cs" Inherits="AmarCentre.Masters.UserControl.UCIncome" %>
                    ...
                    <tr>
                        <td>Name/اسم <span style="color: Red">&nbsp*</span>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txt_name"
                                ValidationGroup="saveI" Display="Dynamic" ErrorMessage="Required" Style="color: Red" InitialValue=""></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td>Description/وصف
                    ...
                    <tr>
                        <td colspan="2">
                            <div>
                                ...
                                <asp:Button ID="btn_save" class="butn_save" ValidationGroup="saveI" OnClick="btn_save_OnClick"
