...
namespace AmarCentre.Masters
{
    public partial class DisplayMenu : System.Web.UI.Page
    {
        ...
        private void CreateDynamicMenu()
        {
            ...
            DataSet dsMenu = obj_master.Get_MenuList(Convert.ToInt32(ViewState["userid"].ToString()), Convert.ToInt32(hdn_user_id.Value));
            ...
            go_upsub:
                ...
                if (dr1["ActId"].ToString() != "")
                    sb.Append("<Node Text='" + dr1["Action"].ToString() + "' Value ='" + dr1["ActId"].ToString() + "' checked='" + dr1["Actchecked"].ToString() + "'/>");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt_Action = new DataTable();
                dt_Action.Columns.Add("Sub_Menu_Id", typeof(int));
                dt_Action.Columns.Add("Action_Id", typeof(int));
                ...
                foreach (RadTreeNode n in listnode)
                {
                    if (n.Value != "")
                    {
                        if (n.IsDescendantOf(SubN) && SubN.Value != "")
                        {
                            dt_Action.Rows.Add(SubN.Value, n.Value);
                        }
                        else
                        {
                ...
                obj_master.Update_EmpMenu(Convert.ToInt32(user_id), dt_Action, dt_detail);
