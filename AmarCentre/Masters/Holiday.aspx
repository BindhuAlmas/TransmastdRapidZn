<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Holiday.aspx.cs" Inherits="AmarCentre.Masters.Holiday" %>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <telerik:RadDatePicker ID="holidayDate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="holidayDate"
                                                ValidationGroup="save" Display="Dynamic" ErrorMessage="Required" Style="color: Red" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
