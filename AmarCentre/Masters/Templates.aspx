<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Templates.aspx.cs" Inherits="AmarCentre.Masters.Templates" %>
                        ...
                        <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr style="display:none">
                                        <td>Department/قسم
                                            <telerik:RadComboBox ID="drpDepartment" Sort="Ascending" Filter="Contains" runat="server"
                                                ...
                                                AutoPostBack="true" OnSelectedIndexChanged="drpChangeOnSelectedIndexChanged"
                                                OnClientBlur="ValidateCombo" EmptyMessage="Search Department..." Style="overflow: hidden; width: 97%; border: none!important;">
                                            </telerik:RadComboBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Services /الخدمات 
                                              <asp:UpdatePanel ID="updService" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                  <ContentTemplate>
                                                      <telerik:RadComboBox ID="drpServices" Sort="Ascending" Filter="Contains" runat="server"
                                                          ...
                                                          OnSelectedIndexChanged="drpServiceOnSelectedIndexChanged" AutoPostBack="true"
                                                          Style="overflow: hidden; width: 97%; border: none!important;">
                                                      </telerik:RadComboBox>
                                                  </ContentTemplate>
                                              </asp:UpdatePanel>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Sort Service Order <span style="color: Red">&nbsp*</span>
                                            <asp:UpdatePanel ID="updServiceSelect" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <telerik:RadComboBox ID="drpServicesSelect" Sort="Ascending" Filter="Contains" runat="server"
                                                        AllowCustomText="true" CheckBoxes="true" RenderMode="Lightweight" DropDownWidth="450px"
                                                        OnItemDataBound="RadComboBox1_ItemDataBound"
                                                        OnClientFocus="OnClientKeyPressing" Style="overflow: hidden; width: 97%; border: none!important;">
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                    <td style="width:80%"><%# DataBinder.Eval(Container.DataItem,"Text")%> 
                                                                        <asp:HiddenField ID="hdnSname" runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"Text")%>' />
                                                                        <asp:HiddenField ID="hdnSId" runat="server" Value='<%# DataBinder.Eval(Container.DataItem,"ServiceId")%>' />
                                                                    </td>
                                                                    <td style="width:19%">
                                                                        <asp:TextBox ID="txtSOrderby" Width="80%"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"Orderby")%>'></asp:TextBox>
                                                                </tr>
                                                            </table>
                                                        </ItemTemplate>
                                                    </telerik:RadComboBox>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpServicesSelect"
