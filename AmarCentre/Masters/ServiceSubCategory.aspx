<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="ServiceSubCategory.aspx.cs" Inherits="AmarCentre.Masters.ServiceSubCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="HeadIng_Div">
        Service Sub Category/فئة الخدمات الفرعية
                ...
                <table class="listTable">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 7%">   Description/وصف
                            </th>
                ...
                <asp:Panel ID="pnl_add" Visible="false" runat="server">
                    ...
                    <div class="animated smallPopUp">
                      <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td>Arabic Name/الاسم بالعربي  <br/>
                                            <asp:TextBox ID="txtArabicName" CssClass="txt" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                           Service Category/فئة الخدمة <span style="color: Red">&nbsp*</span>
                                            <telerik:RadComboBox ID="drpServiceCategory" Sort="Ascending" Filter="Contains" runat="server"
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpServiceCategory"
                                                ValidationGroup="save" Display="Dynamic" ErrorMessage="Required" Style="color: Red" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
