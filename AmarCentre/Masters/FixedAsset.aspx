<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="FixedAsset.aspx.cs" Inherits="AmarCentre.Masters.FixedAsset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <table class="listTable">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 10%">Description/وصف
                            </th>
    ...
    <div>
                        ...
                        <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>Current Value<span style="color: Red">&nbsp*</span>

                                            <br />
                                            <asp:TextBox ID="txtCurrentValue" runat="server" class="txt numbers_only"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCurrentValue"
                                                ValidationGroup="save" Display="Dynamic" ErrorMessage="Required" Style="color: Red" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>OB date
                                             <telerik:RadDatePicker ID="radOBDate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <asp:Button ID="btn_save" class="butn_save" ValidationGroup="save" OnClick="btn_save_OnClick"
                                                 ...
                                                 <asp:Button ID="btnDispose" class="butn" runat="server" Text="Dispose" OnClick="btnDispose_Click" />
                                                 <asp:Button ID="btnHistory" class="butn" runat="server" Text="History" OnClick="btnHistory_Click" />
     ...
     Visible="false" Text="Delete/حذف" OnClick="btn_delete_OnClick" />
                                                ...
                                                <asp:HiddenField ID="hdnDispose" runat="server" Value="0" />
                ...
                <asp:UpdatePanel ID="upddisposal" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Panel ID="pnldisposal" runat="server" Visible="false">
                            ...
                            <div class="animated smallPopUp">
                                ...
                                <table class="formTable">
                                    <tr>
                                        <td>Date
          <telerik:RadDatePicker ID="radDisposaldate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
              <Calendar runat="server" ID="Calendar1" CssClass="rtlSupport" ShowOtherMonthsDays="False"
                  ...
                  <SpecialDays>
                      <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="radDisposaldate"
                                                ValidationGroup="disposal" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                                InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Remark/تعليق <span style="color: Red">&nbsp*</span>
                                            <asp:TextBox ID="txtdisposalRemark" class="txtarea" TextMode="MultiLine" runat="server"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtdisposalRemark"
                                                ValidationGroup="disposal" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                                InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="btndisposeSave" class="butn_save" ValidationGroup="disposal" OnClick="btndisposeSave_Click"
                                                OnClientClick="if (Page_ClientValidate('disposal') == false) return(false);else return confirm('Do you really want to continue.. ?');" runat="server" Text="Dispose" />
                                            <asp:Button ID="btnCloseCancel" class="butn" runat="server" Text="Close/أغلق" OnClick="btnCloseCancel_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
    ...
    <ContentTemplate>
        <asp:Panel ID="pnlhistory" runat="server" Visible="false">
            ...
            <div class="animated smallPopUp" style="width:35%">
                <div class="Adding_heading">
                    History
                </div>
     ...
     Done by 
                        ...
                        <tbody>
                            ...
                            <asp:Button ID="btnhistoryclose" class="butn" runat="server" Text="Close/أغلق" OnClick="btnhistoryclose_Click" />
