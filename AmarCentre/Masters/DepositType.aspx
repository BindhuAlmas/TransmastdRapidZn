<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="DepositType.aspx.cs" Inherits="AmarCentre.Masters.DepositType" %>
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    <tr>
                                     ...
                                     <tr>
                                        <td>Balance
                                            <asp:TextBox ID="txtBalance" ReadOnly="true" CssClass="txt" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
