<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="AccountType.aspx.cs" Inherits="AmarCentre.Masters.AccountType" %>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>Order/طلب 
                                            ...
                                            <br />
                                            <asp:TextBox ID="txt_order" runat="server" class="txt numbers_only"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
