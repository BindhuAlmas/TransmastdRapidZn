<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Shareholder.aspx.cs" Inherits="AmarCentre.Masters.Shareholder" %>
                        ...
                        <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>Share % <span style="color: Red">&nbsp*</span>
                                            <asp:TextBox ID="txtshare" class="txt numbers_only" runat="server"></asp:TextBox>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <asp:Button ID="btn_delete" class="butn_delete" runat="server" OnClientClick="javascript : return confirm('Do you really want to Delete.. ?');"
                                                 ...
                                                 <asp:Button ID="btn_OB" class="butn_save" runat="server" 
                                Visible="false" Text="Opening Balance/الرصيد المفتوح " OnClick="btn_OB_OnClick" />
