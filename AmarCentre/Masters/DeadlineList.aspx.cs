...
{
    public partial class DeadlineList : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.DeadlineExcel(txtFromdate.SelectedDate, txtTodate.SelectedDate, drpCustomer.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpCustomer.SelectedValue),
        ...
        protected void btnPdfOnClick(object sender, EventArgs e)
        {
            ...
            string url = "";
            url = "../Reports/DeadlineListpdf.aspx?FromDate=" + txtFromdate.SelectedDate + "&ToDate=" + txtTodate.SelectedDate +
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=DeadlineExcel.xls");
