<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="SalaryType.aspx.cs" Inherits="AmarCentre.Masters.SalaryType" %>
                      ...
                      <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>
                                            Type/نوع  <span style="color: Red">&nbsp*</span>
                                            <telerik:RadComboBox ID="drp_typ" Sort="Ascending" Filter="Contains" runat="server"
                                ...
                                <Items>
                                    <telerik:RadComboBoxItem Value="1" Text="Addition" />
                                    <telerik:RadComboBoxItem Value="2" Text="Deduction" />
                                </Items>
                            </telerik:RadComboBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drp_typ" Display="Dynamic"
