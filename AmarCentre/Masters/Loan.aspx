<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Loan.aspx.cs" Inherits="AmarCentre.Masters.Loan" %>
                        ...
                        <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chk_IsCreditCard" runat="server" Text="Is Credit Card" AutoPostBack="true" OnCheckedChanged="chk_IsCreditCard_OnCheckedChanged" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="Upd_CreditCardAmount_Panel" runat="server" ChildrenAsTriggers="false"
                                                UpdateMode="Conditional">
                                                <ContentTemplate>

                                                    <asp:Panel ID="pnl_CreditCardAmount" runat="server" Visible="false">
                                                        <div style="margin-bottom: 10px;">
                                                            Credit Amount/المبلغ الائتمان <span style="color: Red">&nbsp*</span>
                                                            <br />
                                                            <asp:TextBox ID="txt_CreditCardAmount" runat="server" class="txt numbers_only"></asp:TextBox>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txt_CreditCardAmount"
                                                                ValidationGroup="save" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                                                InitialValue=""></asp:RequiredFieldValidator>

                                                        </div>
                                                        <div>
                                                            Due Day <span style="color: Red">&nbsp*</span>
                                                            <br />
                                                            <telerik:RadComboBox ID="radDueDate" Sort="Ascending" Filter="Contains" runat="server"
                                                                AllowCustomText="true" RenderMode="Lightweight" OnClientFocus="OnClientKeyPressing"
                                                                OnClientBlur="ValidateCombo" EmptyMessage="Due Day..." Style="overflow: hidden; width: 96%; border: none!important;">
                                                                <Items>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="radDueDate"
                                                                ValidationGroup="save" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                                                InitialValue=""></asp:RequiredFieldValidator>
                                                        </div>
                                                    </asp:Panel>
