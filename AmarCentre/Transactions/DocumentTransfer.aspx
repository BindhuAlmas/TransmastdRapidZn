<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true"
    CodeBehind="DocumentTransfer.aspx.cs" Inherits="AmarCentre.Transactions.DocumentTransfer" %>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <telerik:RadComboBox ID="Drp_Cust" Sort="Ascending" Filter="Contains" runat="server"
                                                AllowCustomText="false" RenderMode="Lightweight" EmptyMessage="Search Agent" Style="width: 50%;
                                                overflow: hidden; border: none!important;" OnClientFocus="OnClientKeyPressing"
                                            ...
                                            <asp:UpdatePanel ID="Upd_doc" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <td colspan="8">
                                                                <span style="float: left">Document List</span>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div style="max-height: 250px; overflow: auto">
                                                <br />
                                                <asp:UpdatePanel ID="Upd_DocList" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <table class="listTable" style="width: 98%">
                                                         <thead>
                                                            <tr>
                                                                <td colspan="7">
                                                                    <span style="float: left">Document List</span>
                                                                    <asp:TextBox ID="txt_doc_search" runat="server" AutoPostBack="true" OnTextChanged="txt_doc_searchoncahneg"
                                                                        placeholder="Search" Style="float: right"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th style="width: 4%">
                                                            ...
                                                            <asp:Repeater ID="rpt_doc_list" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:CheckBox ID="chk_sel" runat="server" AutoPostBack="true" OnCheckedChanged="Onclick_Select" />
                                                                        </td>
                                                                        <td>
                                                                            <asp:Label ID="lbl_name" Text='<%#Eval("Doc_name") %>' runat="server"></asp:Label>
                                                                            <asp:HiddenField ID="hdn_doc_id" runat="server" Value='<%#Eval("Doc_Id") %>' />
