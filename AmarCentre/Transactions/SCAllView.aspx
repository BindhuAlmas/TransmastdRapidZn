<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="SCAllView.aspx.cs" Inherits="AmarCentre.Transactions.SCAllView" %>
                ...
                <div id="div_item_new" runat="server" style="width: 100%; overflow: auto;">
                    <asp:UpdatePanel ID="Upd_List_Panel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <table class="listTable">
                                <thead>
                                    <tr style="text-align: center">
                                        ...
                                        <th style="width: 10%">Particulars
                                        </th>
                                        <th style="width: 9%" runat="server" id="thServAmt">Service Amt
                                        </th>
                                        <th style="width: 7%">Invoice Qty
                                        </th>
                                        <th style="width: 7%">Pending Qty
                                        </th>
                                        <th style="width: 6%">Qty
                                        </th>
                                        <th style="width: 10%">Vendor
                                        </th>
                                        <th style="width: 9%">Expense Amt
                                        </th>
                                        <th style="width: 12%">Account
                                        </th>
                                        <th style="width: 9%">Date
                                        </th>
                                        <th id="thSCStatus" runat="server" style="width: 9%" >Status
                                        </th>
                                ...
                                <tbody>
                                    <asp:Repeater ID="rpt_Item_list" runat="server" OnItemDataBound="rpt_Item_listOnItemDataBound">
                                        <ItemTemplate>
                                            <tr style="text-align: left" runat="server" id="trService">
                                                <td><%#Eval("RowNum") %></td>
                                                <td><%#Eval("Code") %>
                            ...
                            <asp:HiddenField ID="hdn_invStatusIn" runat="server"  Value='<%#Eval("InvoiceStatus") %>' />
                                                </td>
                                                <td><%#Eval("Name") %></td>
                                                ...
                                                <td>
                                                    <telerik:RadDatePicker ID="InlineSerComDate" runat="server" SelectedDate='<%#Eval("SerComDate") %>'
                                                        DateInput-DateFormat="dd/MM/yyyy" Width="100px">
                                                ...
                                                <td id="tdSCStatus" runat="server" style="text-align: left" >
                                        ...
                                        <tr class="temp">
                                            ...
                                            <td>
                                                ...
                                                <telerik:RadComboBox ID="drp_payMode_AE" Sort="Ascending" Filter="Contains" runat="server"
                                                    ...
                                                    Style="overflow: hidden; width: 85%; border: none!important;" OnClientFocus="OnClientKeyPressing"
                                                    OnClientBlur="ValidateCombo" ClientIDMode="AutoID" OnSelectedIndexChanged="drp_payModeAE_OnSelectedIndexChanged"
                                                    AutoPostBack="true">
                                                </telerik:RadComboBox>
                                            ...
                                            <td>
                                                <asp:UpdatePanel ID="Upd_Account_PanelAE" runat="server" ChildrenAsTriggers="false"
                                                    UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rqdaccountInAE" runat="server" ControlToValidate="drp_account_AE"
                                                            ValidationGroup="save" Display="Dynamic" ErrorMessage="*" Style="color: Red"
                                                            InitialValue="">
                                                        </asp:RequiredFieldValidator>
                                                    </ContentTemplate>
                                            ...
                                            <td>
                                                   <asp:UpdatePanel ID="updpaidAmountInAE" runat="server" ChildrenAsTriggers="false"
       UpdateMode="Conditional">
       <ContentTemplate>
                                ...
                                <tr class="temp">
                                    ...
                                    <td>
                                        <asp:UpdatePanel ID="UpdAddAccountPanel" runat="server" ChildrenAsTriggers="false"
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:RequiredFieldValidator ID="rqdaddacc" runat="server" ControlToValidate="drpAddAccount"
                                                    ValidationGroup="inlineaddtnl" Display="Dynamic" ErrorMessage="*" Style="color: Red"
                                                    InitialValue="">
                                                </asp:RequiredFieldValidator>
                                            </ContentTemplate>
                                    ...
                                    <td>
                                          <asp:UpdatePanel ID="updAddPaidAmount" runat="server" ChildrenAsTriggers="false"
      UpdateMode="Conditional">
      <ContentTemplate>
                                        <asp:TextBox ID="txtAddPaidAmount" Class="txt numbers_only paidAmountAddtnl" runat="server"
                                            Text=""></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rqdAddPaidAmount" runat="server" ControlToValidate="txtAddPaidAmount"
                                            ValidationGroup="inlineaddtnl" Display="Dynamic" ErrorMessage="*" Style="color: Red"
                                            InitialValue="">
                                        </asp:RequiredFieldValidator>
              </ContentTemplate>
                        ...
                        <tr>
                            <td>
                                <telerik:RadComboBox ID="drpchangestatus" Sort="Ascending" Filter="Contains" runat="server"
                                    ...
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="Pending" />
                                        <telerik:RadComboBoxItem Value="1" Text="Approved" />
                                        <telerik:RadComboBoxItem Value="2" Text="Rejected" />
                                    </Items>
                                </telerik:RadComboBox>
