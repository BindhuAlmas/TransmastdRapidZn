<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="CIReceipt.aspx.cs" Inherits="AmarCentre.Transactions.CIReceipt" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pageLoad() {
            ...
            $('.amtPayNow').blur(function (e) {
                ...
                else if (RAmt < AmtPayingNow & RAmt > 0) {
                                                        ...
                                                        <table class="listTable">
                                                            ...
                                                            <tbody>
                                                                <asp:Repeater ID="rpt_Item_list" runat="server">
                                                                    <ItemTemplate>
                                                                        <tr style="text-align: center">
                                                                            ...
                                                                            <td style="text-align: left">
                                                                                <asp:TextBox ID="txt_discount" class="numbers_only discount read_Only inline txt asLabel" Width="75%"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        <asp:TextBox class="txt amtPayNow numbers_only txt_80" ID="txt_amtPayNow" runat="server"></asp:TextBox>
                                                ...
                                                <ContentTemplate>
                                                    <asp:Panel ID="pnl_PayMode_Panel" Visible="false" runat="server">
                                                        ...
                                                        <telerik:RadComboBox ID="drpPettyCash" Sort="Ascending" Filter="Contains" runat="server"
                                                            ...
                                                            width: 85%; border: none!important;">
                                                        </telerik:RadComboBox>
                ...
                <asp:Panel ID="pnlCancel" runat="server" Visible="false">
                    ...
                    <div class="animated smallPopUp">
                        ...
                        <div style="padding:10px">
                            <b >Select the entries you want to cancel before cancelling Receipt/حدد الادخالات التي تريد الغاؤها قبل الغاء الفاتورة  </b>
                        </div>
                        <table class="listTable">
                            <thead>
                                <tr>
