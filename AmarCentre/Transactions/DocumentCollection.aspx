<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true"
    CodeBehind="DocumentCollection.aspx.cs" Inherits="AmarCentre.Transactions.DocumentCollection" %>
                        ...
                        <asp:UpdatePanel ID="Upd_Add_PanelInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>
                                            Customer Name/زبون <span style="color: Red">&nbsp*</span>
                                        </td>
                                        <td colspan="3">
                                            <telerik:RadComboBox ID="Drp_Cust" Sort="Ascending" Filter="Contains" runat="server"
                                                AllowCustomText="false" RenderMode="Lightweight" EmptyMessage="Search Customer"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:TextBox ID="txt_desc" TextMode="MultiLine" Width="50%" CssClass="txt_80" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <td colspan="8">
                                                                ...
                                                                <asp:Label ID="lbl_message" runat="server" Style="float: right">0 Documents added</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                           <th style="width: 3%">
                                                        ...
                                                        <asp:Repeater ID="Rpt_Doc" runat="server" OnItemCommand="rpt_doc_list_OnItemCommand">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:Button ID="btn_del" class="btn_delete" runat="server" OnClick="btn_remove_line_OnClick" />
                                                                        <asp:Button ID="btn_dwn" class="btn_doc_down" CommandName="Download" runat="server" />
                                                                    </td>
                                                                </tr>
                                                            </ItemTemplate>
                                                        </asp:Repeater>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <telerik:RadComboBox ID="drp_doc" Sort="Ascending" Filter="Contains" runat="server"
                                                                    AllowCustomText="false" DropDownWidth="200px" RenderMode="Lightweight" EmptyMessage="Search Document"
                                                                    Style="width: 80%; overflow: hidden; border: none!important;" OnClientFocus="OnClientKeyPressing"
                                                                    OnClientBlur="ValidateCombo">
                                                                </telerik:RadComboBox>
                                                                <asp:RequiredFieldValidator ID="req1" runat="server" ControlToValidate="drp_doc"
                                                                    ValidationGroup="docsave" Display="Dynamic" ErrorMessage="*" Style="color: Red"
                                                                    InitialValue=""></asp:RequiredFieldValidator>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txt_num" CssClass="txt_80" Width="90%" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txt_remark" CssClass="txt_80" Width="90%" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txt_remNew" CssClass="txt_80" Width="90%" runat="server"></asp:TextBox>
                                                            </td>
                                                            <td rowspan="2">
                                                                <asp:Button ID="btn_add" class="btn_add_new" ValidationGroup="docsave" runat="server"
