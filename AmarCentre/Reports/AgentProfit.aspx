<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="AgentProfit.aspx.cs" Inherits="AmarCentre.Reports.AgentProfit" %>
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadComboBox ID="drpAgent" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search ..."
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align:right">
                                     ...
                                     <td style="text-align:right">
                                       ...
                                       <td style="text-align:right">
                                        <asp:Label ID="lblvendorcomsn" Text="" runat="server"></asp:Label>
                                    </td>
                                     <td style="text-align:right">
                                     ...
                                     <td style="text-align:right">
                                      ...
                                      <td style="text-align:right">
                                        <asp:Label ID="agentpft" Text="" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="14" class="navigationRow">
