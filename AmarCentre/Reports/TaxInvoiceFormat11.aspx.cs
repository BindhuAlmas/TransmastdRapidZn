...
{
    public partial class TaxInvoiceFormat11 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    emp_details.AddCell(DetailH04);
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Service Charge after discount\n", new Font(Font.FontFamily.UNDEFINED, 9, Font.BOLD)));
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["TotalServiceChargeafterDiscount"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            emp_details.AddCell(DT);
