...
{
    public partial class DebitReportF2 : System.Web.UI.Page
    {
        ...
        {
            DataSet ds  = obj_report.Get_debitors_ReportSOAF8(page_number, page_size, txt_search.Text, drptype.SelectedValue == "" ? 1 : Convert.ToInt32
        ...
        {
            DataSet ds  = obj_report.Get_debitors_ExcelSOAF8(drptype.SelectedValue == "" ? 1 : Convert.ToInt32(drptype.SelectedValue));
        ...
        {
            string url = "../Reports/DebitReportF2Pdf.aspx?Ctype=" + (drptype.SelectedValue == "" ? "1" : drptype.SelectedValue);
        ...
        protected void lnkcust_Click(object sender, EventArgs e)
        {
            ...
            string url = "../Reports/CustomerSOAPdfFormat8.aspx?FromDate=" + null 
           + "&ToDate=" + null + "&Cus=" + Convert.ToInt32(hdnCustomerId.Value) + "&PaymentStatus=0&CompletionStatus=1" ;
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(128, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
