...
{
    public partial class SundryDebtPdf : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.SundryDebitorsExcelPdf();
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=SundryDebit.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Sundry Debtors Report ", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 10f, 50f,  15f, 15f };
                ...
                detailHead = new PdfPCell(new Phrase("Advance ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["Advance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                ...
                dirExpenseCell = new PdfPCell(new Phrase(dt_sum.Rows[0]["Receivable"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
                dirExpenseCell = new PdfPCell(new Phrase(dt_sum.Rows[0]["Advance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
