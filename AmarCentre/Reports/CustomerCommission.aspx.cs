...
{
    public partial class CustomerCommission : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drpCustomer.DataSource = obj_report.GetCommissionApplicableCustomer();
        ...
        {
            DataSet ds = obj_report.CustomerCommissionStatement(Convert.ToInt32(drpCustomer.SelectedValue), txtFromDate.SelectedDate,
                txtToDate.SelectedDate, page_number, page_size);
            DataTable dt = ds.Tables[0];
            rpt_list.DataSource = dt;
            rpt_list.DataBind();
            lblName.Text = ds.Tables[2].Rows[0]["Name"].ToString();
            if (dt.Rows.Count > 0)
            {
            ...
            else
            {
                ...
                lblcredit.Text = lbldebit.Text = lblBalance.Text = "";
            }
        ...
        {
            DataSet ds = obj_report.CustomerCommissionStatementExcel(Convert.ToInt32(drpCustomer.SelectedValue), txtFromDate.SelectedDate,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=CustomerCommission.xls");
        ...
        {
            string url = "";
            url = "../Reports/CustomerCommissionPdf.aspx?FromDate=" + txtFromDate.SelectedDate + "&ToDate=" + txtToDate.SelectedDate +
               "&CustomerId=" + Convert.ToInt32(drpCustomer.SelectedValue);
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(49, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
