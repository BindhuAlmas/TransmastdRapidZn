<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="CreditProfitReport.aspx.cs" Inherits="AmarCentre.Reports.CreditProfitReport" %>
                            ...
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px;">Net Profit
                                      ...
                                      <th style="padding: 5px;">Receivable Profit
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                      ...
                                      <td style="text-align: right">
                                        <asp:Label ID="lblrecivableProfit" Text="" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
