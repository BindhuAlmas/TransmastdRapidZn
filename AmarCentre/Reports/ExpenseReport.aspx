<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true"
    CodeBehind="ExpenseReport.aspx.cs" Inherits="AmarCentre.Reports.ExpenseReport" %>
                ...
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        <tr>
                            <td>
                                ...
                                <telerik:RadDatePicker ID="txt_reg_Frm_date" runat="server" class="input-boder" DateInput-DateFormat="dd/MM/yyyy">
                                 ...
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txt_reg_Frm_date"
                         ...
                         <tr>
                                        <td>
                                            ...
                                            <telerik:RadComboBox ID="drpTo" Sort="Ascending" Filter="Contains" runat="server"
                                                ...
                                                EmptyMessage="Search Type..." Style="overflow: hidden; width: 86%; border: none!important;">
                                                <Items>
                        ...
                        <tr>
                            <td>
                                Expense Type
                                <telerik:RadComboBox ID="drp_expense" ClientIDMode="AutoID" Sort="Ascending" Filter="Contains"
                                    AllowCustomText="true" RenderMode="Lightweight" OnClientFocus="OnClientKeyPressing"
                                    EmptyMessage="Search Expense..." CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
