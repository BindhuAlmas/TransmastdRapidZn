...
{
    public partial class TaxInvoiceFormat2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            iTextSharp.text.Font arbsmallbold = new iTextSharp.text.Font(bfTimes, 8, Font.NORMAL);
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                Chargedamt = dt_inv.Rows[0]["ChargedAmount"].ToString() != "" ? Convert.ToDecimal(dt_inv.Rows[0]["ChargedAmount"]) / dt_invD.Rows.Count : 0;
                decimal caout = 0;
                /*Tax Invoice Type*/
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    PdfPTable emp_details = new PdfPTable(11);
                    emp_details.DefaultCell.Padding = 4;
                    float[] widthsdet = new float[] { 5f, 30f, 13f, 9f, 9f,9f, 9f,7f, 8f, 7f, 11f };
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Other Service", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        {
                            //Phrase phrase14 = new Phrase();
                            //phrase14.Add(new Chunk(rows["ParticularsD"].ToString(), arbsmallbold));

                            //PdfPCell REM = new PdfPCell(phrase14);
                            ////REM.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                        ...
                        try
                        {
                            PdfPCell sn = new PdfPCell(new Phrase(rows["ChargedAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            sn.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            sn.Border = 0;
                            emp_details.AddCell(sn);
                        }
                        catch (Exception ee)
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["TaxAmountTot"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;//rows["TaxAmount"].ToString()
                            DT.Border = 0;
                            emp_details.AddCell(DT);
                        }
                        catch (Exception eee)
                        ...
                        try
                        {
                            decimal ca = Convert.ToDecimal(rows["ChargedAmount"]) + Convert.ToDecimal(rows["Total"]);

                            PdfPCell sn = new PdfPCell(new Phrase(ca.ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            sn.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            sn.Border = 0;
                            emp_details.AddCell(sn);
                        }
                    ...
                    DetailEnd00 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    DetailEnd00.HorizontalAlignment = PdfPCell.ALIGN_CENTER;//dt_sum.Rows[0]["TQuantity"].ToString()
                    DetailEnd00.Border = PdfPCell.TOP_BORDER;
                    emp_details.AddCell(DetailEnd00);

                    PdfPCell tot1 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    tot1.Border = PdfPCell.TOP_BORDER;//dt_sum.Rows[0]["TAmount"].ToString()
                    tot1.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(tot1);

                    tot1 = new PdfPCell(new Phrase(dt_inv.Rows[0]["ChargedAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    ...
                    caout =  Convert.ToDecimal(dt_inv.Rows[0]["ChargedAmount"]) + Convert.ToDecimal(dt_sum.Rows[0]["Total"]);

                    tot1 = new PdfPCell(new Phrase(caout.ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    tot1.Border = PdfPCell.TOP_BORDER;
                    tot1.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(tot1);
                ...
                else if (dt_inv.Rows[0]["InvoiceType"].ToString() == "2")/*Normal Invoice Type*/
                {
                    ...
                    emp_details.DefaultCell.Padding = 4;
                    float[] widthsdet = new float[] { 5f, 30f, 13f, 10f, 10f,10f, 10f, 10f, 12f };
                    emp_details.SetWidths(widthsdet);
                    emp_details.SpacingBefore = 10f;
                    emp_details.WidthPercentage = 95f;
                    ph1 = new Phrase();
                    ...
                    emp_details.AddCell(DetailH04);
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Other Service", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    DetailH04.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    DetailH04.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.TOP_BORDER;
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            ...
                            PdfPCell sn = new PdfPCell(new Phrase(Chargedamt.ToString("0.00"), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            sn.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            sn.Border = 0;
                            emp_details.AddCell(sn);
                        }
                        ...
                        try
                        {
                            ...
                            decimal ca = Chargedamt + Convert.ToDecimal(rows["Total"]);
                            PdfPCell sn = new PdfPCell(new Phrase(ca.ToString("0.00"), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            sn.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            sn.Border = 0;
                            emp_details.AddCell(sn);
                        }
                ...
                float[] widths1 = new float[] { 50f, 20f, 5f, 8f };
                ...
                PdfPCell totw1wcc = new PdfPCell(new Phrase("Total Amount ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(totw1wcc);

                totw1wcc = new PdfPCell(new Phrase(":", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(totw1wcc);

                totw1wcc = new PdfPCell(new Phrase((caout - (dt_sum.Rows[0]["TTAx"].ToString() == "" ? 0 : Convert.ToDecimal(dt_sum.Rows[0]["TTAx"].ToString()))).ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                totalexp.AddCell(totw1wcc);
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    totw1wcc = new PdfPCell(new Phrase("Taxable Amount ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(totw1wcc);
                    ...
                    totw1wcc = new PdfPCell(new Phrase(dt_sum.Rows[0]["TSC"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(totw1wcc);
                    ...
                    totw1wcc = new PdfPCell(new Phrase("VAT (5%) ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(totw1wcc);
                    ...
                    totw1wcc = new PdfPCell(new Phrase(dt_sum.Rows[0]["TTAx"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(totw1wcc);
                    ...
                    totw1wcc = new PdfPCell(new Phrase("Net Total(Incl. of VAT) AE ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(totw1wcc);
                    ...
                    totw1wcc = new PdfPCell(new Phrase(caout.ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(totw1wcc);
                }
                ...
                totw1wcc = new PdfPCell(new Phrase("Received ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(totw1wcc);
                ...
                totw1wcc = new PdfPCell(new Phrase(dt_inv.Rows[0]["Received"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                totalexp.AddCell(totw1wcc);
                ...
                totw1wcc = new PdfPCell(new Phrase("Balance ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(totw1wcc);
                ...
                totw1wcc = new PdfPCell(new Phrase(dt_inv.Rows[0]["Receivable"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                totw1wcc.Border = 0;
                totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                totalexp.AddCell(totw1wcc);
                ...
                ph1.Add(new Chunk("Amount in words: UAE Dirhams "+ ConvertNumbertoWords(GrandtotalFinal) + " Only", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLDITALIC)));
                ...
                termsCell.Border = 0;
                termsCell.Colspan = 4;
                termsCell.MinimumHeight = 30f;
                termsCell.VerticalAlignment = Element.ALIGN_BOTTOM;
