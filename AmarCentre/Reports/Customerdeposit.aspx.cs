...
{
    public partial class Customerdeposit : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drpVendor.DataSource = obj_report.Drp_Customer();
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.CustomerDepositDetailList(Convert.ToInt32(drpVendor.SelectedValue), txt_reg_Frm_date.SelectedDate,
                 txt_reg_to_date.SelectedDate, page_number, page_size);
        ...
        {
            DataSet ds = obj_report.CustomerDepositDetailExcel(Convert.ToInt32(drpVendor.SelectedValue),
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Customerdeposit.xls");
        ...
        {
            string url = "../Reports/Customerdepositsummary.aspx";
        ...
        protected void btnPdfDetOnClick(object sender, EventArgs e)
        {
            string url = "../Reports/CustomerdepositDet.aspx";
            ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "NewWindow", "window.open('" + url + "','_blank','height=600,width=900,status=no,toolbar=no,menubar=no,location=no,scrollbars=no,resizable=no,titlebar=no' );", true);
        }
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(74, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
