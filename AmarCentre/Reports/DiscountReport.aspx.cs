...
namespace AmarCentre.Reports
{
    public partial class DiscountReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.DiscountShortlistExcel(FromDate, ToDate, CustomerId);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=DiscountReport.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Discount Report", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            PdfPCell sub001 = new PdfPCell(new Phrase("Date : " + DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss").Replace('-', '/'), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub001.Border = 0;
            sub001.HorizontalAlignment = Element.ALIGN_LEFT;
            headTable.AddCell(sub001);
            /*End of Row*/
            ...
            if (dtSummary.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 10f,12f,29f,12f, 12f, 15f, 10f };
                ...
                detailHead = new PdfPCell(new Phrase("Receipt Code", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
               
                detailHead = new PdfPCell(new Phrase("Invoice Code", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
                ...
                foreach (DataRow rows in dtSummary.Rows)
                {
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["Date"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["Customer"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingLeft = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["ReceiptCode"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingLeft = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["InvoiceCode"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingLeft = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["ContactNo"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingLeft = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                ...
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.Colspan = 6;
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);

                dirExpenseCell = new PdfPCell(new Phrase(dtSum.Rows[0][0].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
