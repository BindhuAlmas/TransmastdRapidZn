<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="PartnerReport.aspx.cs" Inherits="AmarCentre.Reports.PartnerReport" %>
            ...
            <asp:Panel ID="pnl_filter" runat="server">
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Partner <span style="color: Red">&nbsp*</span>
                                <telerik:RadComboBox ID="drppartner" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Partner..."
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drppartner"
