...
{
    public partial class Pendingservicepdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.PendingserviceExcelPdf(FromDate, ToDate,dtService, dt_cust, departmentId, agentId, ServiceStatusId,
                Applicant);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=PendingService.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Pending Service", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] widths = new float[] { 4f, 10f, 10f, 20f, 15f, 20f, 15f, 8f, 9f, 10f };
                ...
                app = new PdfPCell(new Phrase("Particulars", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                app.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(app);

                app = new PdfPCell(new Phrase("Invoice Qty", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                app.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(app);

                app = new PdfPCell(new Phrase("Pending Qty", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                app.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(app);
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["InvoiceQty"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        TP.PaddingLeft = 10f;
                        emp_details.AddCell(TP);
                    }
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["PendingQty"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        TP.PaddingLeft = 10f;
                        emp_details.AddCell(TP);
                    }
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["Amount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        emp_details.AddCell(TP);
                    }
                    catch (Exception eee)
