<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="CustomerCommission.aspx.cs" Inherits="AmarCentre.Reports.CustomerCommission" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="HeadIng_Div">
        Customer Commission/لجنة العملاء
                    ...
                    <ContentTemplate>
                        <table class="listTable" style="width: 98%; border: 1px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="4" style="padding-left: 3px; white-space: nowrap;text-align:right">Total</td>
                                ...
                                <tr>
                                    <td colspan="5" style="padding-left: 3px; white-space: nowrap;text-align:right">Balance</td>
