...
namespace AmarCentre.Reports
{
    public partial class AgentCommission : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.AgentCommissionStatement(Convert.ToInt32(drpAgent.SelectedValue), txtFromDate.SelectedDate,
        ...
        {
            DataSet ds = obj_report.AgentCommissionStatementExcel(Convert.ToInt32(drpAgent.SelectedValue), txtFromDate.SelectedDate,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=AgentCommission.xls");
        ...
        {
            string url = "";
            url = "../Reports/AgentCommissionPdf.aspx?FromDate=" + txtFromDate.SelectedDate + "&ToDate=" + txtToDate.SelectedDate +
               "&AgentId=" + Convert.ToInt32(drpAgent.SelectedValue);
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(131, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
