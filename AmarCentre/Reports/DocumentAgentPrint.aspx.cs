...
{
    public partial class DocumentAgentPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds2 = rep1.DocReturnAgent(Id);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=DocumentReturnAgent.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Document Return Acknowledgement", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
