...
{
    public partial class PartnerPdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.PartnerStatmentExcel(PartnerId,FromDate, ToDate);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=PartnerStatement.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Partner Statement", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            sub00 = new PdfPCell(new Phrase("Name : " + dtEmp.Rows[0]["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            /*End of Row*/
            sub00 = new PdfPCell(new Phrase("Opening Balance : " + dtEmp.Rows[0]["OpeningBalance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            ///*End of Row*/
            sub00 = new PdfPCell(new Phrase("Closing Balance : " + dtEmp.Rows[0]["ClosingBalance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            /*End of Row*/
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 8f, 20f, 10f, 10f  };
                ...
                detailsTable.AddCell(detailCell);
                detailCell = new PdfPCell(new Phrase(dtEmp.Rows[0]["Debit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);

                detailCell = new PdfPCell(new Phrase(dtEmp.Rows[0]["Credit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);
