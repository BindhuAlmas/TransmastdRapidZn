<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="InvoiceReport.aspx.cs" Inherits="AmarCentre.Reports.InvoiceReport" %>
                ...
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>Payment Status
                                <br />
                                <telerik:RadComboBox ID="drpPayment" Sort="Ascending" EmptyMessage="Search ..."
                                    Filter="Contains" AllowCustomText="true" RenderMode="Lightweight" OnClientFocus="OnClientKeyPressing"
                                    runat="server" Style="height: 24px !important; width: 86%; overflow: hidden; border: none!important;">
                                    <Items>
                                        <telerik:RadComboBoxItem Value="0" Text="All" />
                                        <telerik:RadComboBoxItem Value="1" Text="Pending" />
                                        <telerik:RadComboBoxItem Value="2" Text="Partially Paid" />
                                        <telerik:RadComboBoxItem Value="3" Text="Fully Paid" />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="btnsummary" class="butn" runat="server" ValidationGroup="save" Text="Summary"
                                    OnClick="btnsummaryOnClick" />
                        ...
                        <table class="listTable" style="width: 200%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px; width: 5%">Customer Type
                                    </th>
                                    <th style="padding: 5px">Date
                                    </th>
                                    <th style="width: 15%; padding: 5px; white-space: nowrap">Service
                                    </th>
                                    <th style="padding: 5px;">Applicant
                                    </th>
                                    <th style="padding: 5px;">Invoice Creator
                                    </th>
                                    <th style="padding: 5px;">Updated date&time
                                    </th>
                                    <th style="padding: 5px;">Govt.Fee
                                    </th>
                                    <th style="padding: 5px;">Service Charge
                                    </th>
                                    <th style="padding: 5px;">Tax
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Invoice Amount
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Fine
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Paid Amount
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Balance
                                    </th>
                                    <th style="padding: 5px;">Mode of Receipt
                                    </th>
                                    <th style="padding: 5px;">Work Status
                                    </th>

                                    <th style="padding: 5px; white-space: nowrap">Expense Paid
                                    </th>
                                    <th style="padding: 5px;">SC Employee Name
                                    </th>
                                    <th style="padding: 5px;">Mode of Payment
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Expense Payable
                                    </th>
                                    <th style="padding: 5px;">Vendor Commission 
                                    </th>
                                    <th style="padding: 5px;">Customer Commission 
                                    </th>
                                    <th style="padding: 5px;">Tax Received
                                    </th>
                                    <th style="padding: 5px;">Tax Paid
                                    </th>
                                    <th style="padding: 5px;">Tax Payable
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap">Profit
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalServiceCharge" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalTax" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalInvoiceAmt" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right"></td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalPaid" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalBal" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td></td>
                                    <td></td>

                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalExpPaid" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right"></td>
                                    <td style="text-align: right"></td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalExpPayable" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblvendrcommission" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblCommission" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblReceivedTax" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblPaidTax" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTaxPayable" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="lblTotalProfit" Text="" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
