<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="VendorOutstanding.aspx.cs" Inherits="AmarCentre.Reports.VendorOutstanding" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="HeadIng_Div">
       Vendor Outstanding Report/البائع المتميز
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right">
                                        <asp:Label ID="lblTotalPayable" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align:right">
