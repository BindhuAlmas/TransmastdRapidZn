...
{
    public partial class VendorCommission : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.VendorCommissionlist(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblBalance.Text = ds.Tables[0].Rows[0]["Receivable"].ToString();
        ...
        {
            string url =  "../Reports/VendorCommissionPdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(76, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
