...
{
    public partial class AgentCommissionPdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.AgentCommissionStatementPdf(AgentId, FromDate, ToDate);
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Agent Commission", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            PdfPCell Serial_Nocu = new PdfPCell(new Phrase("Agent :", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
            ...
            float[] widths = new float[] { 7f, 10f, 10f,25f, 25f, 25f, 10f };
            ...
            if (dtDetails.Rows.Count > 0 || dtreceipt.Rows.Count > 0)
            {
                ...
                if (dtDetails.Rows.Count > 0)
                {
                    ...
                    Ser = new PdfPCell(new Phrase("Customer", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                    Ser.HorizontalAlignment = Element.ALIGN_CENTER;
                    income_details.AddCell(Ser);
                    ...
                    Qua = new PdfPCell(new Phrase("Applicant", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                    Qua.HorizontalAlignment = Element.ALIGN_CENTER;
                    income_details.AddCell(Qua);
                    ...
                    foreach (DataRow rows in dtDetails.Rows)
                    {
                        ...
                        try
                        {
                            PdfPCell typee = new PdfPCell(new Phrase(rows["Customer"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        ...
                        try
                        {
                            PdfPCell typee = new PdfPCell(new Phrase(rows["Applicant"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            typee.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            income_details.AddCell(typee);
                        }
                        catch (Exception eee)
                        ...
                        try
                        {
                            PdfPCell typee = new PdfPCell(new Phrase(rows["AgentCommission"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
