...
{
    public partial class CashReceiptFormat3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CashReceiptPrint3(id);
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk("", arbfnt));
            ph1.Add(new Chunk(" Received from Mr./Mrs./M/s", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            ...
            /*End of Row*/
            sub00 = new PdfPCell(new Phrase(dt.Rows[0]["CustomerName"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.Colspan = 2;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub00);
            ...
            //PdfPCell sub13 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            //sub13.Border = 0;
            //sub13.Colspan = 2;
            ...
            ph1.Add(new Chunk(" / Receipt Date", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            ...
            sub24a = new PdfPCell(new Phrase(" ", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub24a.Border = 0;
            sub24a.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub24a);
            ...
            float[] DetailsTableWidth = new float[] { 25f, 25f, 20f, 25f, 25f,15f, 15f };
            DetailsTable.SetWidths(DetailsTableWidth);
            DetailsTable.WidthPercentage = 95f;
            float RowHeight = 25f;
            float SmallRowHeight = 20f;

            decimal ReceivedAmount = Convert.ToDecimal(dt.Rows[0]["Amount"].ToString());
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            ph1.Add(new Chunk("المبلغ بالكلمات", arbfnt));
            ph1.Add(new Chunk(" / Amount In Word", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a = new PdfPCell(ph1);
            ...
            sub33a = new PdfPCell(new Phrase("AED " + ConvertNumbertoWords(ReceivedAmount) + " Only ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLDITALIC)));
            sub33a.Border = 0;
            sub33a.HorizontalAlignment = Element.ALIGN_MIDDLE;
            sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
            sub33a.Colspan = 5;
            sub33a.FixedHeight = SmallRowHeight;
            DetailsTable.AddCell(sub33a);
            ...
            if (dt.Rows[0]["PaymentModeId"].ToString() == "3")
            {

                ph1 = new Phrase();
                ph1.Add(new Chunk("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                ph1.Add(new Chunk("", arbfnt));
                ph1.Add(new Chunk("Payment Details", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a = new PdfPCell(ph1);
                //sub33a = new PdfPCell(new Phrase("Net Amount:", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a.Border = PdfPCell.BOTTOM_BORDER;
                sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                sub33a.FixedHeight = SmallRowHeight;
                DetailsTable.AddCell(sub33a);

                sub33a = new PdfPCell(new Phrase("chq #", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a.Border = PdfPCell.BOTTOM_BORDER;
                sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                sub33a.FixedHeight = SmallRowHeight;
                ...
                sub33a = new PdfPCell(new Phrase(dt.Rows[0]["ChequeNumber"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a.Border = PdfPCell.BOTTOM_BORDER;
                sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                sub33a.FixedHeight = SmallRowHeight;
                ...
                sub33a = new PdfPCell(new Phrase("chq Date", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a.Border = PdfPCell.BOTTOM_BORDER;
                sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                sub33a.FixedHeight = SmallRowHeight;
                ...
                sub33a = new PdfPCell(new Phrase(dt.Rows[0]["ChequeDates"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub33a.Border = PdfPCell.BOTTOM_BORDER;
                sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                sub33a.FixedHeight = SmallRowHeight;
                ...
                if (!string.IsNullOrEmpty(dt.Rows[0]["bank"].ToString()))
                {
                    sub33a = new PdfPCell(new Phrase("bank", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    sub33a.Border = PdfPCell.BOTTOM_BORDER;
                    sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                    sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                    sub33a.FixedHeight = SmallRowHeight;
                    ...
                    sub33a = new PdfPCell(new Phrase(dt.Rows[0]["bank"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    sub33a.Border = PdfPCell.BOTTOM_BORDER;
                    sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
                    sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
                    sub33a.FixedHeight = SmallRowHeight;
            ...
            else if (!string.IsNullOrEmpty(dt.Rows[0]["bank"].ToString()))
            {
                ph1 = new Phrase();
                ph1.Add(new Chunk("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                ph1.Add(new Chunk("", arbfnt));
            ...
            //if (dtCustomer.Rows[0]["IsAddRemark"].ToString() == "1")
            //{
            Subhead = new PdfPTable(1);
            Subhead.DefaultCell.Padding = 4;
            Subhead.SpacingBefore = 10f;
            Subhead.WidthPercentage = 95f;
            ...
            PdfPCell sub2d1 = new PdfPCell(new Phrase("Remark : " + dt.Rows[0]["ReceiptRemark"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub2d1.Border = PdfPCell.BOTTOM_BORDER;
            ...
            sub33a = new PdfPCell(new Phrase("Customer Signature", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a.Border = 0;
            sub33a.Colspan = 2;
            sub33a.PaddingLeft = 30f;
            sub33a.HorizontalAlignment = Element.ALIGN_LEFT;
            sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
            sub33a.MinimumHeight = 25f;
            DetailLine.AddCell(sub33a);

            sub33a = new PdfPCell(new Phrase(dt.Rows[0]["Cashier"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a.HorizontalAlignment = Element.ALIGN_CENTER;
            sub33a.Border = 0;
            sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
            DetailLine.AddCell(sub33a);
            ...
            PdfPCell termsCell = new PdfPCell(new Phrase("This is a computer generated document/ does not require signature/Stamp", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            termsCell.Border = 0;
            termsCell.MinimumHeight = 55f;
            termsCell.Colspan = 3;
            sub33a.VerticalAlignment = Element.ALIGN_BOTTOM;
            termsCell.HorizontalAlignment = Element.ALIGN_LEFT;
            DetailLine.AddCell(termsCell);
