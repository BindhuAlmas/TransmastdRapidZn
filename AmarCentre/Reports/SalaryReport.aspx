<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="SalaryReport.aspx.cs" Inherits="AmarCentre.Reports.SalaryReport" %>
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <tr>
                               ...
                               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="drp_employee"
                                    Display="Dynamic" ValidationGroup="save" ErrorMessage="Required" Style="color: Red"
                                    InitialValue=""></asp:RequiredFieldValidator>
                            </td>
                            </tr>
