...
using AmarCentre.Masters.UserControl;

namespace AmarCentre.Reports
{
    public partial class ServiceProfitStatementpdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt_Emply = (DataTable)Session["dt_Emply"];
            DataTable dt_Service = (DataTable)Session["dt_Service"];
            DataTable dt_Department = (DataTable)Session["dt_Department"];
            DataTable dt_Invoice = (DataTable)Session["dt_Invoice"];
            DataTable dt_Customer = (DataTable)Session["dt_Customer"];

            DataSet ds  = obj_report.ServiceProfitStatementExcelNew(FromDate, ToDate, dt_Customer, dt_Department, dt_Service, dt_Invoice, dt_Emply, vendorId, agentId);
            DataTable dt = ds.Tables[0];

            Document document = new Document(PageSize.A4, 20f, 20f, 20f, 20f);

            HttpContext.Current.Response.ContentType = "application/pdf";
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=ServiceProfitStatementpdf.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("SERVICE PROFIT STATEMENT", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] widths = new float[] { 5f, 17f, 15f, 25f, 25f, 32f, 22f, 18f };
                ...
                PdfPCell tp = new PdfPCell(new Phrase("SCDate", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                tp.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(tp);
                tp = new PdfPCell(new Phrase("Invoice", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                tp.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(tp);
                ...
                PdfPCell app = new PdfPCell(new Phrase("Agent", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                ...
                app = new PdfPCell(new Phrase("Employee", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                app.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(app);

                app = new PdfPCell(new Phrase("Profit", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                app.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(app);
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["SCDate"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["InvoiceCode"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        emp_details.AddCell(TP);
                    }
                    catch (Exception eee)
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["Employee"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["NetProfit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        emp_details.AddCell(TP);
                    }
                    catch (Exception eee)
                ...
                TPo = new PdfPCell(new Phrase(ds.Tables[1].Rows[0]["NetProfit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
