...
{
    public partial class QuotationInvoiceNav : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.QuotationInvoiceList(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
        ...
        {
            DataSet ds = obj_report.QuotationInvoiceExcel(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate);
            DataTable dt = ds.Tables[0];
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=QuotationInvoice.xls");
        ...
        {
            string url = "../Reports/QuotationInvoicePdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(114, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
