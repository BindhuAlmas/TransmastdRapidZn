...
namespace AmarCentre.Reports
{
    public partial class InvoiceSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.InvoiceSummaryReport(FromDate, ToDate, AgentId);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=InvoiceSummary.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Invoice Summary", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 8f, 8f, 15f, 10f };
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["AfterDiscount_GrandTotal"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                ...
                detailsTable.AddCell(detailCell);
                detailCell = new PdfPCell(new Phrase(dtsum.Rows[0]["AfterDiscount_GrandTotal"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);
