<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="OutstandingTaxPayable.aspx.cs" Inherits="AmarCentre.Reports.OutstandingTaxPayable" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="HeadIng_Div">
        Outstanding Tax Payable/الضريبة المستحقة الدفع
                    ...
                    <ContentTemplate>
                        <table class="listTable" style="width: 98%; border: 1px">
                            ...
                            <td style="padding-left: 3px; white-space: nowrap">
                                ...
                                <asp:Label ID="lblTaxReceived" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
                            <td style="padding-left: 3px; white-space: nowrap;text-align:right">
                                <asp:Label ID="lblTaxPaid" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
                            <td style="padding-left: 3px; white-space: nowrap;text-align:right">
                                <asp:Label ID="lblOutstandingTaxPayable" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
                            </tr>
