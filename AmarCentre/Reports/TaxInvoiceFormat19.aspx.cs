...
{
    public partial class TaxInvoiceFormat19 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_inv.Rows[0]["InvoiceTRN"].ToString() != "")
                ph1.Add(new Chunk("\n\nVAT# : " + dt_inv.Rows[0]["InvoiceTRN"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            ...
            PdfPCell sub23 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub23.Border = 0;
            ...
            PdfPCell sub13 = new PdfPCell(ph1);
            sub13.Border = 0;
            sub13.HorizontalAlignment = Element.ALIGN_RIGHT;
            sub13.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            ...
            sub00 = new PdfPCell(ph1);
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_RIGHT;
            sub00.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            Subhead.AddCell(sub00);
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    float[] widthsdet = new float[] { 5f, 30f, 13f, 8f, 8f, 9f, 9f, 8f, 11f };
                    ...
                    //DetailH04.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    //DetailH04.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.TOP_BORDER;
                   //a emp_details.AddCell(DetailH04);
                    ph1 = new Phrase();
                    ...
                    emp_details.AddCell(DetailH04);
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Amount Before VAT\n", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    ph1.Add(new Chunk("المبلغ قبل الضريبة", arbsmallbold));
                    DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    DetailH04.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    //DetailH04.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.TOP_BORDER;
                    ...
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    DetailH04.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    DetailH04.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.TOP_BORDER | Rectangle.RIGHT_BORDER;
                    emp_details.AddCell(DetailH04);
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            ...
                            REM.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER;
                            emp_details.AddCell(REM);
                        }
                        catch (Exception eee)
                        {
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["UnitAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["Amount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            DT.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER;
                            emp_details.AddCell(DT);
                        }
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["SingleTaxAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            DT.Border = Rectangle.LEFT_BORDER | Rectangle.RIGHT_BORDER;
                            emp_details.AddCell(DT);
                        }
                    ...
                    DetailEnd00.Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.RIGHT_BORDER | PdfPCell.BOTTOM_BORDER;
                    ...
                    tot1.Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.RIGHT_BORDER | PdfPCell.BOTTOM_BORDER;
                    ...
                    tot1.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(tot1);
                    tot1 = new PdfPCell(new Phrase(dt_sum.Rows[0]["NetAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    tot1.Border = PdfPCell.TOP_BORDER | PdfPCell.LEFT_BORDER | PdfPCell.RIGHT_BORDER | PdfPCell.BOTTOM_BORDER;
                    tot1.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(tot1);
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("المبلغ قبل الضريبة", arbfnt));
                    ph1.Add(new Chunk(" / Amount Before VAT", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    PdfPCell sub01 = new PdfPCell(ph1);
                    sub01.Border = 0;
                    sub01.Colspan = 2;
                    sub01.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub01.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub01);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk(dt_sum.Rows[0]["NetAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    PdfPCell sub01a = new PdfPCell(ph1);
                    sub01a.Border = 0;
                    sub01a.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub01a.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub01a);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk("ضريبة", arbfnt));
                    ph1.Add(new Chunk(" / VAT", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    PdfPCell sub02 = new PdfPCell(ph1);
                    sub02.Border = 0;
                    sub02.Colspan = 2;
                    sub02.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub02.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub02);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk(dt_sum.Rows[0]["TTAx"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    PdfPCell sub02a = new PdfPCell(ph1);
                    sub02a.Border = 0;
                    sub02a.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub02a.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub02a);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk("المجموع الإجمالي", arbfnt));
                    ph1.Add(new Chunk(" / Grand Total", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    PdfPCell sub03 = new PdfPCell(ph1);
                    sub03.Border = 0;
                    sub03.Colspan = 2;
                    sub03.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub03.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub03);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk(dt_sum.Rows[0]["Total"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                    PdfPCell sub03a = new PdfPCell(ph1);
                    sub03a.Border = 0;
                    sub03a.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    sub03a.HorizontalAlignment = Element.ALIGN_LEFT;
                    totalexp.AddCell(sub03a);
                ...
                else if (dt_inv.Rows[0]["InvoiceType"].ToString() == "2")/*Normal Invoice Type*/
                {
                    ...
                    emp_details.DefaultCell.Padding = 4;
                    float[] widthsdet = new float[] { 5f, 30f, 13f, 10f, 10f, 10f, 11f };
                    emp_details.SetWidths(widthsdet);
                    emp_details.SpacingBefore = 10f;
