...
{
    public partial class CustomerdepositDet : System.Web.UI.Page
    {
        Report_Bal obj_report = new Report_Bal();

        protected void Page_Load(object sender, EventArgs e)
        {
            DataSet ds = obj_report.CustomerDepositDetPdf();
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=Customerdepositdetail.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Customer deposit Detail", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    try
                    {
                        detailCell = new PdfPCell(new Phrase((++i).ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["Amount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["Paid"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                        detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                        detailsTable.AddCell(detailCell);
                    }
                    catch (Exception ee)
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["Balance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                        detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                        detailsTable.AddCell(detailCell);
                    }
                    catch (Exception ee)
                    ...
                    DataRow[] rin = dtdet.Select("Customer_Id=" + rows["CId"]);
                    foreach (DataRow r in rin)
                    {
                        try
                        {
                        ...
                        try
                        {
                            detailCell = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            detailCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            detailCell.PaddingLeft = 10f;
                            detailsTable.AddCell(detailCell);
                        }
                        catch (Exception ee)
                        {
                        ...
                        try
                        {
                            detailCell = new PdfPCell(new Phrase(r["Amount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            detailsTable.AddCell(detailCell);
                        }
                        catch (Exception ee)
                        ...
                        try
                        {
                            detailCell = new PdfPCell(new Phrase(r["Paid"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            detailsTable.AddCell(detailCell);
                        }
                        catch (Exception ee)
                        ...
                        try
                        {
                            detailCell = new PdfPCell(new Phrase(r["Balance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            detailsTable.AddCell(detailCell);
                        }
                        catch (Exception ee)
