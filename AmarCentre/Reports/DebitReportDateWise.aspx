<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="DebitReportDateWise.aspx.cs" Inherits="AmarCentre.Reports.DebitReportDateWise" %>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadComboBox ID="drptype" Sort="Ascending" Filter="Contains" runat="server"
                                    ...
                                    Style="overflow: hidden; width: 90%; border: none!important;">
                                    <Items>
                                ...
                                <asp:Repeater ID="rpt_list" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="padding-left: 3px; white-space: nowrap;text-align: right;padding-right:1%">
                                                <%#Eval("Amount")%>
                                            </td>
                                            <td style="padding-left: 3px; white-space: nowrap">
                                                <%#Eval("CreditCustomer")%>
