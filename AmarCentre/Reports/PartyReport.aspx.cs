...
{
    public partial class PartyReport : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drpParty.DataSource = obj_report.fillParty();
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.Party_Report(txtFromDate.SelectedDate, txtToDate.SelectedDate,
                drpParty.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpParty.SelectedValue), page_number, page_size);
        ...
        {
            DataSet ds = obj_report.Get_Party_Excel(txtFromDate.SelectedDate, txtToDate.SelectedDate, drpParty.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpParty.SelectedValue));
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=PartyReport_Excel.xls");
        ...
        {
            string url = "../Reports/PartyReportPdf.aspx?FromDate=" + txtFromDate.SelectedDate
        + "&ToDate=" + txtToDate.SelectedDate + "&PartyId=" + (drpParty.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpParty.SelectedValue));
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(126, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
