...
{
    public partial class ServiceExpiry : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.ServiceExpiryStatement(txtFromDate.SelectedDate, txtToDate.SelectedDate,
                 dtCustomer,  dtService,  page_number, page_size);
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.ServiceExpiryExcel(txtFromDate.SelectedDate, txtToDate.SelectedDate, dtCustomer,  dtService);
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=ServiceExpiry.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(62, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
