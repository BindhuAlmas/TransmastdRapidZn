...
{
    public partial class TaxInvoiceFormat8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            PdfPCell sub21add = new PdfPCell(new Phrase("Contact Person :", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
            sub21add.Border = 0;
            sub21add.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub21add);

            PdfPCell sub122add = new PdfPCell(new Phrase(dt_cust.Rows[0]["ContactPerson"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
            sub122add.Border = 0;
            ...
            sub21add = new PdfPCell(new Phrase("MOHRE No :", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
            sub21add.Border = 0;
            sub21add.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub21add);

            sub122add = new PdfPCell(new Phrase(dt_cust.Rows[0]["MohreNo"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
            sub122add.Border = 0;
            sub122add.Colspan = 4;
            sub122add.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub122add);
            sub21add = new PdfPCell(new Phrase("License No :", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
            sub21add.Border = 0;
            sub21add.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub21add);

            sub122add = new PdfPCell(new Phrase(dt_cust.Rows[0]["licenseNo"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
            sub122add.Border = 0;
            sub122add.Colspan = 4;
            sub122add.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub122add);
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                float[] widthsdet = new float[] { 4f, 25f, 10f, 8f, 8f, 5f, 9f };
