...
namespace AmarCentre.Reports
{
    public partial class PartnerReport : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drppartner.DataSource = obj_report.GetPartnerList();
        ...
        {
            DataSet ds = obj_report.PartnerStatment(Convert.ToInt32(drppartner.SelectedValue), txtFromDate.SelectedDate,
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                lblAccountName.Text = ds.Tables[1].Rows[0]["Name"].ToString();
        ...
        {
            string url = "../Reports/PartnerPdf.aspx?FromDate=" + txtFromDate.SelectedDate
        + "&ToDate=" + txtToDate.SelectedDate + "&PartnerId=" + Convert.ToInt32(drppartner.SelectedValue);
        ...
        {
            DataSet ds = obj_report.PartnerStatmentExcel(Convert.ToInt32(drppartner.SelectedValue), txtFromDate.SelectedDate,txtToDate.SelectedDate);
            DataTable dt = ds.Tables[0];
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=partnershare.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(104, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
