...
{
    public partial class TaxInvoiceFormat15 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_invD.Rows.Count > 0)
            {
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    float[] widthsdet = new float[] { 4f, 23f,20f, 5f, 7f, 7f, 5f, 8f };
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Non Taxable Amount", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    PdfPCell DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    emp_details.AddCell(DetailH04);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Taxable Amount", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Vat 5%", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    emp_details.AddCell(DetailH04);
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            ...
                            PdfPCell DT = new PdfPCell(new Phrase(rows["NonTaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        ...
                        try
                        {
                            //PdfPCell DT = new PdfPCell(new Phrase(rows["Taxableamount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                            PdfPCell DT = new PdfPCell(new Phrase(rows["TaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            emp_details.AddCell(DT);
                    ...
                    summ = new PdfPCell(new Phrase(dt_sum.Rows[0]["TotalNonTaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    summ.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(summ);
                    summ = new PdfPCell(new Phrase(dt_sum.Rows[0]["TotalTaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    summ.HorizontalAlignment = Element.ALIGN_RIGHT;
                    emp_details.AddCell(summ);
                ...
                else if (dt_inv.Rows[0]["InvoiceType"].ToString() == "2")/*Normal Invoice Type*/
                {
                    ...
                    emp_details.DefaultCell.Padding = 4;
                    float[] widthsdet = new float[] { 4f, 25f, 22f, 5f, 8f,   8f };
                    emp_details.SetWidths(widthsdet);
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            //decimal amt = Convert.ToDecimal(rows["Total"]) +( Convert.ToDecimal(rows["Discount"]) * Convert.ToDecimal(rows["Quantity"]));

                            PdfPCell DT = new PdfPCell(new Phrase(rows["TotalwithDis"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            emp_details.AddCell(DT);
                        }
                        catch (Exception eee)
                ...
                if(dt_inv.Rows[0]["InvoiceType"].ToString() == "2")
                {
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    tot2ww = new PdfPCell(new Phrase("Total Non Taxable Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    tot2ww.MinimumHeight = 20f;
                    totalexp.AddCell(tot2ww);
                    tot2ww = new PdfPCell(new Phrase(dt_sum.Rows[0]["TotalNonTaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(tot2ww);
                    ...
                    tot2ww = new PdfPCell(new Phrase("Total Taxable Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    tot2ww.MinimumHeight = 20f;
                    totalexp.AddCell(tot2ww);
                    tot2ww = new PdfPCell(new Phrase(dt_sum.Rows[0]["TotalTaxableamountafterDiscount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(tot2ww);
                    ...
                    tot2ww = new PdfPCell(new Phrase("Total Vat", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    tot2ww.MinimumHeight = 20f;
                    totalexp.AddCell(tot2ww);
                ...
                tot2ww.MinimumHeight = 20f;
                totalexp.AddCell(tot2ww);
                tot2ww = new PdfPCell(new Phrase((Convert.ToDecimal(dt_sum.Rows[0]["TotalNoRound"])+Convert.ToDecimal(dt_inv.Rows[0]["RoundedOff"])).ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                totalexp.AddCell(tot2ww);
                ...
                {
                    tot2ww = new PdfPCell(new Phrase("Created By\n" + dt_inv.Rows[0]["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    tot2ww.Border = 0;
