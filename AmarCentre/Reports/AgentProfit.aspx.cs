...
{
    public partial class AgentProfit : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.AgentProfitStatement(txtFromDate.SelectedDate,txtToDate.SelectedDate, 
                Convert.ToInt32(drpAgent.SelectedValue), page_number, page_size);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                agentpft.Text = ds.Tables[1].Rows[0]["AgentProfit"].ToString();
                lblvendorcomsn.Text = ds.Tables[1].Rows[0]["VendorCommission"].ToString();
            ...
            else
            {
                ...
                lbl_payabletax.Text = "";
                lbl_pft.Text = "";
                lbl_commssion.Text = agentpft.Text = lblvendorcomsn.Text= lblincentive.Text= "";
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.AgentProfitStatementExcel(txtFromDate.SelectedDate, txtToDate.SelectedDate,
                Convert.ToInt32(drpAgent.SelectedValue));
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=AgentProfitStatement.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(115, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
