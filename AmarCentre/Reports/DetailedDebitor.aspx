<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="DetailedDebitor.aspx.cs" Inherits="AmarCentre.Reports.DetailedDebitor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="HeadIng_Div">
     Detailed Debitors Report/تقرير المدينين
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btn_excel" class="butn" runat="server" Text="Generate Excel"
                                      ...
                                      <asp:Button ID="Button1" class="butn" runat="server" Text="Generate Pdf"
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px; white-space: nowrap;width:7%">
                                        Credit Customer
                                    </th>
                                </tr>
                            </thead>
                                ...
                                <asp:Repeater ID="rpt_list" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="padding-right: 8px; white-space: nowrap;text-align:right">
                                                <%#Eval("Amount")%>
                                            </td>
                                              <td style="padding-left: 3px; white-space: nowrap">
                                                <%#Eval("CreditCustomer")%>
