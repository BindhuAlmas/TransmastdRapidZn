<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="SundryDebtors.aspx.cs" Inherits="AmarCentre.Reports.SundryDebtors" %>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-right: 8px;text-align:right">
                                        <asp:Label ID="lbladvance" Text="" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
