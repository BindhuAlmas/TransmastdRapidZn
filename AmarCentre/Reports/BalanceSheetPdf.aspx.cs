...
{
    public partial class BalanceSheetPdf : System.Web.UI.Page
    {
        ...
        public void ReportGen()
        {
            ...
            DataSet ds = rep1.BalancesheetAM(ToDate);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    try
                    {
                        if (rows["subordrE"].ToString() == "1" || rows["subordrE"].ToString() == "3"  || rows["subordrE"].ToString() == "5"
                            || rows["subordrE"].ToString() == "7" || rows["subordrE"].ToString() == "9" || rows["subordrE"].ToString() == "11"
                            || rows["subordrE"].ToString() == "12")
                        {
                        ...
                        else if (rows["subordrE"].ToString() == "2" || rows["subordrE"].ToString() == "4" || rows["subordrE"].ToString() == "6"
                            || rows["subordrE"].ToString() == "8" || rows["subordrE"].ToString() == "10" || rows["subordrE"].ToString() == "13")
                        {
                    ...
                    try
                    {
                        if (rows["subordr"].ToString() == "1" || rows["subordr"].ToString() == "3" || rows["subordr"].ToString() == "5"
                            || rows["subordr"].ToString() == "7" || rows["subordr"].ToString() == "9" || rows["subordr"].ToString() == "11"
                            || rows["subordr"].ToString() == "13" || rows["subordr"].ToString() == "15")
                        {
                            PdfPCell typee = new PdfPCell(new Phrase(rows["Names"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                            typee.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            income_details.AddCell(typee);
                        }
                        else if (rows["subordr"].ToString() == "2" || rows["subordr"].ToString() == "4" || rows["subordr"].ToString() == "6"
                            || rows["subordr"].ToString() == "8" || rows["subordr"].ToString() == "10" || rows["subordr"].ToString() == "12"
                            || rows["subordr"].ToString() == "14" || rows["subordr"].ToString() == "16")
                        {
