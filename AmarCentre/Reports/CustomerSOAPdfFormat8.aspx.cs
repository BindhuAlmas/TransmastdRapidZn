...
{
    public partial class CustomerSOAPdfFormat8 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            document.Open();
            if (Application["PrintHeader"].ToString() != "")
            {
            ...
            float[] widths = new float[] { 7f, 10f, 10f, 30f, 10f, 10f, 8f, 10f, 10f };
            ...
            if (dtDetails.Rows.Count > 0 || dtreceipt.Rows.Count > 0)
            {
                ...
                if (dtDetails.Rows.Count > 0)
                {
                    ...
                    Quanot.HorizontalAlignment = Element.ALIGN_CENTER;
                    income_details.AddCell(Quanot);
                    Quanot = new PdfPCell(new Phrase("Fine", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                    Quanot.HorizontalAlignment = Element.ALIGN_CENTER;
                    income_details.AddCell(Quanot);
                    ...
                    foreach (DataRow rows in dtDetails.Rows)
                    {
                        ...
                        foreach (DataRow r in dh.Rows)
                        {
                            ...
                            income_details.AddCell(Stypee);
                             ...
                             Stypee = new PdfPCell(new Phrase(r["Rate"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            ...
                            Stypee = new PdfPCell(new Phrase(r["Fine"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                            Stypee.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            Stypee.Border = Rectangle.RIGHT_BORDER | Rectangle.LEFT_BORDER; 
                            if (rr == 0)
                                Stypee.Border = Rectangle.RIGHT_BORDER | Rectangle.LEFT_BORDER | Rectangle.TOP_BORDER;
