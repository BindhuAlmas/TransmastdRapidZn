...
{
    public partial class SalesOrderFormat23 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ph1.Add(new Chunk("SALES ORDER DATE: ", new Font(Cambria9)));
            ...
            TP = new PdfPCell(new Phrase("SALES ORDER", new Font(Roboto14)));
            TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            TP.Border = 0;
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk("SALES ORDER NO: ", new Font(Cambria9)));
            ph1.Add(new Chunk(dtBasic.Rows[0]["Code"].ToString(), new Font(Cambria9bd)));
            sub00 = new PdfPCell(new Phrase(ph1));
            sub00.Border = 0;
            sub00.Colspan = 3;
            sub00.Padding = 5f;
            sub00.VerticalAlignment = Element.ALIGN_BOTTOM;
            Subhead.AddCell(sub00);
