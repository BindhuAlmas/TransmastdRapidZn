...
{
    public partial class PettyCashStatement : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drpPettyCash.DataSource = obj_report.GetPettyCashAccountList(Convert.ToInt32(hdn_user_id.Value));
            ...
            CodeItem.Text = "All";
            CodeItem.Value = "0";
            drpPettyCash.Items.Insert(0, CodeItem);
        }

        public void grid_fill(int page_number, int page_size)
        {
            DataSet ds = obj_report.PettyCashStatementVersion2(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                Convert.ToInt32(drpPettyCash.SelectedValue), page_number, page_size,Convert.ToInt32(hdn_user_id.Value));
        ...
        {
            DataSet ds = obj_report.PettyCashStatementExcelVersion2(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                Convert.ToInt32(drpPettyCash.SelectedValue), Convert.ToInt32(hdn_user_id.Value));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=PettyCashStatement.xls");
        ...
        {
            string url = "../Reports/PettyCashStatementPdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate
        + "&ToDate=" + txt_reg_to_date.SelectedDate + "&CashId=" + Convert.ToInt32(drpPettyCash.SelectedValue) + 
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(39, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
