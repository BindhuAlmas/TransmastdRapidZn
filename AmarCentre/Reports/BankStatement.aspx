<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="BankStatement.aspx.cs" Inherits="AmarCentre.Reports.BankStatement" %>
            ...
            <asp:Panel ID="pnl_filter" runat="server">
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Bank Account <span style="color: Red">&nbsp*</span>
                                <telerik:RadComboBox ID="drpBank" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Bank Account..."
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpBank"
                                    Display="Dynamic" ValidationGroup="save" ErrorMessage="Required" Style="color: Red"
                                    InitialValue=""></asp:RequiredFieldValidator>
                            </td>
                        </tr>
            ...
            <div style="overflow-x: auto; min-height: 250px; width: 100%">
                <asp:UpdatePanel ID="Upd_List_Panel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="width:5%;padding: 5px; white-space: nowrap">
                                        Debit
                                    </th>
                                    <th style="width:5%;padding: 5px; white-space: nowrap">
                                        Credit
                        ...
                        <br />
                        <table class="listTable" style="width: 55%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    <th style="width: 35%; white-space: nowrap">
                                       Bank account
                                    </th>
                                    <th style="padding: 5px;width: 15%;">
                                        Balance
                                    </th>
                                </tr>
                            </thead>
