...
{
    public partial class TaxInvoiceFormat17 : System.Web.UI.Page
    {
        ...
        (decimal.TryParse(rows["Expense"]?.ToString(), out var expense) ? expense : 0) +
