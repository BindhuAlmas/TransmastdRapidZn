...
{
    public partial class TaxInvoiceFormat4 : System.Web.UI.Page
    {
            ...
            {
                {
                    ...
                    float[] widthsdet = new float[] { 4f, 35f,   5f, 7f, 9f, 5f, 5f, 7f };
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Transaction Charges", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    emp_details.AddCell(DetailH04);

                    ph1 = new Phrase();
                    ph1.Add(new Chunk("Disc.", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    DetailH04 = new PdfPCell(ph1);
                    DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                    emp_details.AddCell(DetailH04);
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        {
                            ph1 = new Phrase();
                            ph1.Add(new Chunk(rows["Name"].ToString()+"\n", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                            ph1.Add(new Chunk(rows["ParticularsD"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                            DetailH04 = new PdfPCell(ph1);

                            //PdfPCell sn = new PdfPCell(new Phrase(rows["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                            //sn.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            //emp_details.AddCell(sn);

                            DetailH04.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            emp_details.AddCell(DetailH04);
                        }
                        catch (Exception eee)
                        {
