...
{
    public partial class CustomerInvoiceFormat2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CustomerInvoicePrintFormat2(id);
            ...
            if (dtTRNFromGeneral.Rows[0]["TRN"].ToString() != "")
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (dtTRNFromGeneral.Rows[0]["IsAddRemark"].ToString() != "0")
                {
                    ...
                    //PdfPCell remarksCell = new PdfPCell(new Phrase("Remarks: "+ dt_inv.Rows[0]["Remarks"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
