...
{
    public partial class DocumentTransferPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds2 = rep1.DocTransfrPRint(Id);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=DocumentTransfer.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Document Transfer Acknowledgement", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
