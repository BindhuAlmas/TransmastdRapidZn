...
{
    public partial class TaxInvoiceFormat22 : System.Web.UI.Page
    {
            ...
            {
                {
                    ...
                    ph1 = new Phrase();
                    ph1.Add(new Chunk("المبلغ مع الضريبة ", arbsmallN));
                    ph1.Add(new Chunk("\n", arbsmallN));
                    ph1.Add(new Chunk("Amount incl vat", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                    DetailH03 = new PdfPCell(ph1);
                    DetailH03.HorizontalAlignment = Element.ALIGN_CENTER;
                    DetailH03.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                    emp_details.AddCell(DetailH03);
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            ...
                            //ph1 = new Phrase();
                            //ph1.Add(new Chunk(rows["NameInArabic"].ToString(), arbsmallN));
                            //ph1.Add(new Chunk("\n", arbsmallN));
                            //ph1.Add(new Chunk(rows["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));

                            //PdfPCell sn = new PdfPCell(new Phrase(ph1));
                            //sn.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                            //sn.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                            //emp_details.AddCell(sn);
                        }
                        catch (Exception eee)
                        {
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase((Convert.ToDecimal(rows["Amount"]) + Convert.ToDecimal(rows["SingleTaxAmount"]) - Convert.ToDecimal(rows["Discount"])).ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            emp_details.AddCell(DT);
                    ...
                    emp_details.AddCell(summ);
                    //summ = new PdfPCell(new Phrase((Convert.ToDecimal(dt_sum.Rows[0]["TSCExp"])+Convert.ToDecimal(dt_sum.Rows[0]["TTAx"])).ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    //summ.HorizontalAlignment = Element.ALIGN_RIGHT;
                    //emp_details.AddCell(summ);
                    ...
                    ////tot2ww = new PdfPCell(new Phrase("Net Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    ////tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    ////tot2ww.MinimumHeight = 20f;
                    ////totalexp.AddCell(tot2ww);
                    //tot2ww = new PdfPCell(new Phrase(dt_sum.Rows[0]["Total"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
