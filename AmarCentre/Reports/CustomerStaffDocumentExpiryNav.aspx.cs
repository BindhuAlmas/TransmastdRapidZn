...
{
    public partial class CustomerStaffDocumentExpiryNav : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                txt_reg_to_date.SelectedDate = DateTime.Now.AddDays(30);
            }
        }
        ...
        public void fill_Drp_down()
        {
            ...
            drpSponser.DataSource = obj_master.fillsponser();
            ...
            drpCustomerStaff.DataSource = obj_master.fill_drp_CustomerStaff(0);
            drpCustomerStaff.DataTextField = "text";
            drpCustomerStaff.DataValueField = "value";
            drpCustomerStaff.DataBind();
        }

        protected void drpCustomerStaffOnSelectedIndexChanged(object sender, EventArgs e)
        {
            int c_id = drp_Cust.SelectedValue == "" ? 0 : Convert.ToInt32(drp_Cust.SelectedValue);
            drpCustomerStaff.Text = "";
            drpCustomerStaff.ClearSelection();
            drpCustomerStaff.Items.Clear();
            drpCustomerStaff.DataSource = obj_report.fill_drp_CustomerStaff(c_id);
            drpCustomerStaff.DataTextField = "text";
            drpCustomerStaff.DataValueField = "value";
            drpCustomerStaff.DataBind();
        ...
        {
            DataSet ds = obj_report.CustomerDocumentStaff(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate, page_number, page_size,
                drp_Cust.SelectedValue == "" ? (int?)null : Convert.ToInt32(drp_Cust.SelectedValue),
                 drpSponser.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSponser.SelectedValue),
                 drpCustomerStaff.SelectedValue,
        ...
        {
            DataSet ds = obj_report.CustomerDocumentStaffExcel(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                drp_Cust.SelectedValue == "" ? (int?)null : Convert.ToInt32(drp_Cust.SelectedValue),
                 drpSponser.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSponser.SelectedValue),
                 drpCustomerStaff.SelectedValue,
                  drpagent.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpagent.SelectedValue));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=CustomerDocumentStaffExcel.xls");
        ...
        protected void btn_excelF2_OnClick(object sender, EventArgs e)
        {
            DataSet ds = obj_report.CustomerDocumentStaffExcelF2(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                drp_Cust.SelectedValue == "" ? (int?)null : Convert.ToInt32(drp_Cust.SelectedValue),
                 drpSponser.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSponser.SelectedValue),
                 drpCustomerStaff.SelectedValue,
                  drpagent.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpagent.SelectedValue));
        ...
        protected void btnPdfOnClick(object sender, EventArgs e)
        {
            ...
            string url = "";
            url = "../Reports/CustomerStaffDocumentExpiryNavpdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate + "&ToDate=" + txt_reg_to_date.SelectedDate +
               "&CustomerId=" + drp_Cust.SelectedValue + "&SponserId=" + drpSponser.SelectedValue + "&CustomerStaff=" + drpCustomerStaff.SelectedValue + "&AgentId=" + drpagent.SelectedValue;
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(83, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
