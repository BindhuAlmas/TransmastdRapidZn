...
{
    public partial class CustomerDocumentExpirypdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CustomerDocumentExcel(FromDate, ToDate, dt_cust, SponserId, AgentId);
            DataTable dt = ds.Tables[0];

            Document document = new Document(PageSize.A4, 20f, 20f, 20f, 20f);

            HttpContext.Current.Response.ContentType = "application/pdf";
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=CustomerDocument.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Customer Document", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] widths = new float[] { 6f, 25f, 25f, 25f, 25f, 24f, 20f, 20f };
                ...
                PdfPCell tp2 = new PdfPCell(new Phrase("Contactno", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                tp2.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(tp2);
                PdfPCell tp3 = new PdfPCell(new Phrase("DocumentName", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                tp3.HorizontalAlignment = Element.ALIGN_CENTER;
                emp_details.AddCell(tp3);
                PdfPCell app = new PdfPCell(new Phrase("DocumentNo", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
