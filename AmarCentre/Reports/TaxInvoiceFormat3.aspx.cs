...
{
    public partial class TaxInvoiceFormat3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                EmptyTerms = new PdfPCell(new Phrase("This document is computer generated and does not require signature or stamp inorder to be considered valid.", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                EmptyTerms.Border = 0;
                EmptyTerms.MinimumHeight = 30f;
                EmptyTerms.HorizontalAlignment = Element.ALIGN_LEFT;
                EmptyTerms.VerticalAlignment = Element.ALIGN_BOTTOM;
                EmptyTerms.Colspan = 3;
                terms.AddCell(EmptyTerms);
