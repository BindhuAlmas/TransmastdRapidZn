...
{
    public partial class ServiceProfitSummary : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.ServiceProfitSummary(FromDate, ToDate);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=ServiceProfitSummary.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Service Profit Summary", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            HT00.HorizontalAlignment = Element.ALIGN_CENTER;
            HT00.Border = 0;
            headTable.AddCell(HT00);
            /*End of Row*/
            HT00 = new PdfPCell(new Phrase(dt_sum.Rows[0]["FromTo"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
            HT00.HorizontalAlignment = Element.ALIGN_CENTER;
            HT00.Border = 0;
            headTable.AddCell(HT00);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] {5f,  15f, 15f };
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["Dated"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["Profit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                ...
                dirExpenseCell = new PdfPCell(new Phrase(dt_sum.Rows[0]["Total"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
