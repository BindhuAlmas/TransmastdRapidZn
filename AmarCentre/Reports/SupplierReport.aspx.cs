...
namespace AmarCentre.Reports
{
    public partial class Supplier : System.Web.UI.Page
    {
        ...
        public void fill_Drp_down()
        {
            ...
            drpSupplier.DataSource = obj_report.Drp_Supplier();
            drpSupplier.DataTextField = "text";
            drpSupplier.DataValueField = "value";
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.Supplier_Report(txtFromDate.SelectedDate, txtToDate.SelectedDate,
                drpSupplier.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSupplier.SelectedValue), page_number, page_size);
        ...
        {
            DataSet ds = obj_report.Get_Supplier_Excel(txtFromDate.SelectedDate, txtToDate.SelectedDate, drpSupplier.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSupplier.SelectedValue));
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=SupplierReport_Excel.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(124, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
