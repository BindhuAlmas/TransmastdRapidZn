...
{
    public partial class WorkSummaryDetailPdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dtPendCredit = ds.Tables[5];
            DataTable dtRecCredit = ds.Tables[6];
            DataTable dtWorkPend = ds.Tables[7];
            DataTable dtWorkComp = ds.Tables[8];
            DataTable dtPrevCredit = ds.Tables[9];
            DataTable dtPrevWorkProcs = ds.Tables[10];

            DataTable dtCashOut = ds.Tables[11];
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("Work Summary Detail", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            income_details.SpacingBefore = 10;
            ...
            //if (dtinv.Rows.Count > 0)
            {
                ...
                foreach (DataRow r in dtCashOut.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                    Sert.PaddingLeft = 35f;
                    Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                    income_details.AddCell(Sert);
                    Sert = new PdfPCell(new Phrase(r["Debit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_RIGHT;
                ...
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                income_details.AddCell(Sert);
                foreach (DataRow r in dtRecCredit.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                    ...
                    Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                    income_details.AddCell(Sert);
                    Sert = new PdfPCell(new Phrase(r["Amount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_RIGHT;
                    Sert.MinimumHeight = 20f;
                    Sert.PaddingRight = 25f;
                    Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                Sert = new PdfPCell(new Phrase("Todays Credit", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                Sert.MinimumHeight = 25f;
                Sert.PaddingLeft = 15f;
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                foreach (DataRow r in dtPrevCredit.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                ...
                foreach (DataRow r in dtPendCredit.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                ...
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                income_details.AddCell(Sert);
                foreach (DataRow r in dtWorkComp.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                ...
                Sert = new PdfPCell(new Phrase("Todays Work In Processing", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                Sert.MinimumHeight = 25f;
                Sert.PaddingLeft = 15f;
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                income_details.AddCell(Sert);
                foreach (DataRow r in dtPrevWorkProcs.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
                ...
                Sert.VerticalAlignment = Element.ALIGN_MIDDLE;
                income_details.AddCell(Sert);
                foreach (DataRow r in dtWorkPend.Rows)
                {
                    Sert = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                    Sert.HorizontalAlignment = Element.ALIGN_LEFT;
                    Sert.MinimumHeight = 20f;
