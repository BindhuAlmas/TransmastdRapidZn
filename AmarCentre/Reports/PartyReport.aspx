<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="PartyReport.aspx.cs" Inherits="AmarCentre.Reports.PartyReport" %>
                ...
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Party 
                                <telerik:RadComboBox ID="drpParty" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Party..."
