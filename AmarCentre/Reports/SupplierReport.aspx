<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Supplier.aspx.cs" Inherits="AmarCentre.Reports.Supplier" %>
                ...
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Supplier 
                                <telerik:RadComboBox ID="drpSupplier" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Supplier..."
