<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true"
    CodeBehind="CustomerSOA.aspx.cs" Inherits="AmarCentre.Reports.CustomerSOA" %>
                ...
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Payment Status
                                <telerik:RadComboBox ID="drpPaymentStatus" ClientIDMode="AutoID" Sort="Ascending"
                                    EmptyMessage="Search Payment Status..." Filter="Contains" AllowCustomText="true"
                                    ...
                                    <Items>
                                        ...
                                        <telerik:RadComboBoxItem Value="1" Text="Fully Paid" />
                                        <telerik:RadComboBoxItem Value="2" Text="Unpaid" />
                                        <telerik:RadComboBoxItem Value="3" Text="Partially Paid" />
                                        <telerik:RadComboBoxItem Value="4" Text="Fully Paid & Partially Paid" />
                                        <telerik:RadComboBoxItem Value="5" Text="Unpaid & Partially Paid" />
                                    </Items>
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
                            <tr>
                                <td>
                                    Completion Status
                                    <telerik:RadComboBox ID="drpCompletionStatus" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Completion Status..."
                                        Filter="Contains" AllowCustomText="true" RenderMode="Lightweight" OnClientFocus="OnClientKeyPressing"
                                        OnClientBlur="ValidateCombo" runat="server" Style="height: 24px !important; width: 86%;
                                        overflow: hidden; border: none!important;">
                                        <Items>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Button ID="btnPdf" class="butn" runat="server" ValidationGroup="save" Text="Generate PDF"
                                     ...
                                     <asp:Button ID="btnSendmail" class="butn" runat="server" ValidationGroup="save" Text="Sendmail"
                                      OnClick="btSendmailOnClick" />
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <%-- <td style="padding-left: 3px; white-space: nowrap;">
                                <asp:Label ID="lblCustomerType" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
