<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="CICustomerSOA.aspx.cs" Inherits="AmarCentre.Reports.CICustomerSOA" %>
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadComboBox ID="drpPaymentStatus" ClientIDMode="AutoID" Sort="Ascending"
                                    ...
                                    <Items>
                                        <telerik:RadComboBoxItem Value="1" Text="Paid" />
                        ...
                        <tr>
                            <tr>
                                <td>
                                    Completion Status
                                    <telerik:RadComboBox ID="drpCompletionStatus" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Payment Status..."
                                        Filter="Contains" AllowCustomText="true" RenderMode="Lightweight" OnClientFocus="OnClientKeyPressing"
                                        OnClientBlur="ValidateCombo" runat="server" Style="height: 24px !important; width: 86%;
                                        overflow: hidden; border: none!important;">
                                        <Items>
