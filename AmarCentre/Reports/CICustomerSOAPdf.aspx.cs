...
{
    public partial class CICustomerSOAPdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CICustomerSOAPrintFormat2(FromDate, ToDate, CustomerId, PaymentStatus, CompletionStatus);
            ...
            if (dtDetails.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 15f, 15f, 20f, 20f, 20f };
