<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="AccountSummaryReport.aspx.cs" Inherits="AmarCentre.Reports.AccountSummaryReport" %>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px; width: 10%">Opening Balance
                                    </th>
                                    <th style="padding: 5px; width: 10%">Inward
                                    </th>
                                    <th style="padding: 5px; width: 10%">Outward
                                    </th>
                                    <th style="padding: 5px; width: 10%">Closing Balance
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right">
                                        <asp:Label ID="lblTotalCredit" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align:right">
                                        <asp:Label ID="lblTotalDebit" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
