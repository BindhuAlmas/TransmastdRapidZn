<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Pendingservice.aspx.cs" Inherits="AmarCentre.Reports.Pendingservice" %>
                        ...
                        <tr>
                            <td>Customer 
                                <telerik:RadComboBox ID="drp_Customer" Sort="Ascending" Filter="Contains" runat="server"
                                    ...
                                    AutoPostBack="true" OnSelectedIndexChanged="drp_Customer_SelectedIndexChanged"
                          ...
                          <tr>
                            <td>
                                <asp:UpdatePanel ID="updApplicant" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        Applicant 
                                <telerik:RadComboBox ID="drpApplicant" Sort="Ascending" Filter="Contains" runat="server"
                                    AllowCustomText="true" RenderMode="Lightweight" EmptyMessage="Search ..." OnClientFocus="OnClientKeyPressing"
                                    Style="overflow: hidden; width: 86%; border: none!important;">
                                </telerik:RadComboBox>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    <th style="width: 3%; white-space: nowrap">Sl No.
                                    </th>
                                    <th style="width: 8%">Invoice
                                    </th>
                                    ...
                                    <th style="width: 12%">Particulars
                                    </th>
                                    <th style="width:5%">Invoice Qty
                                    </th>
                                    <th style="width: 5%">Pending Qty
                                    </th>
                                    <th style="width: 7%">Pending Qty Amount
                                    </th>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="padding-left: 3px;">
                                             ...
                                             <td style="padding-left: 3px;">
                                                 <%#Eval("InvoiceQuantity")%>
                                             </td>
                                             <td style="padding-left: 3px;">
                                                 <%#Eval("InPendingQuantity")%>
                                             </td>
                                             <td style="padding-left: 3px;">
                                                 <%#Eval("PendingQtyAmount")%>
                                             </td>
                                            <td style="padding-left: 3px;">
