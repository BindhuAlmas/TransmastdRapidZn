...
{
    public partial class CashReceiptFormat6 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ph1.Add(new Chunk("RECEIPT DATE: ", new Font(Cambria9)));
            ph1.Add(new Chunk(dtInvoice.Rows[0]["QDate"].ToString(), new Font(Cambria9bd)));
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk(dtGen.Rows[0]["CompanyName"].ToString() +
                "\n\nTRN : " + dtInvoice.Rows[0]["InvoiceTRN"].ToString() + "\n", new Font(Cambria10)));
            ...
            TP = new PdfPCell(new Phrase("RECEIPT", new Font(Roboto14)));
            TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            TP.Border = 0;
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk("RECEIPT NO : ", new Font(Cambria9)));
            ph1.Add(new Chunk(dtInvoice.Rows[0]["Reciptcode"].ToString(), new Font(Cambria9bd)));
            sub00 = new PdfPCell(new Phrase(ph1));
            sub00.Border = 0;
            sub00.Colspan = 3;
            ...
            ph1 = new Phrase();
            ph1.Add(new Chunk("INVOICE NO : ", new Font(Cambria9)));
            ph1.Add(new Chunk(dtInvoice.Rows[0]["Code"].ToString(), new Font(Cambria9bd)));
            sub00 = new PdfPCell(new Phrase(ph1));
            sub00.Border = 0;
            sub00.Colspan = 3;
            sub00.PaddingLeft = 5f;
            ...
            if (dtInvoice.Rows[0]["subject"].ToString() != "")
            {
                ...
                ph1.Add(new Chunk(dtInvoice.Rows[0]["subject"].ToString(), new Font(Cambria9bd)));
                sub00 = new PdfPCell(new Phrase(ph1));
                sub00.Border = 0;
                sub00.Colspan = 3;
                sub00.PaddingLeft = 5f;
            ...
            if (dtdetail.Rows.Count > 0)
            {
                ...
                float[] widthsdet = new float[] { 30f, 6f, 12f, 10f, 10f, 15f };
                emp_details.SetWidths(widthsdet);
                emp_details.WidthPercentage = 95f;
                emp_details.SpacingBefore = 10f;

                ph1 = new Phrase();
                ph1.Add(new Chunk("PRODUCT & SERVICE", new Font(Roboto10)));
                ...
                ph1 = new Phrase();
                ph1.Add(new Chunk("GROSS AMOUNT", new Font(Roboto10)));
                DetailH02 = new PdfPCell(ph1);
                DetailH02.HorizontalAlignment = Element.ALIGN_CENTER;
                DetailH02.VerticalAlignment = Element.ALIGN_MIDDLE;
                DetailH02.Border = 0;
                ...
                foreach (DataRow rows in dtdetail.Rows)
                {
                    try
                    {
                        ...
                        REMIN.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.TOP_BORDER;
                ...
                DTO = new PdfPCell(new Phrase("AED " + dtInvoice.Rows[0]["Total_Discount"].ToString(), new Font(Calibri10wt)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                //DTO.Colspan = 2;
                DTO.MinimumHeight = 20f;
                DTO.VerticalAlignment = PdfPCell.ALIGN_MIDDLE;
                ...
                DTO = new PdfPCell(new Phrase("GRAND TOTAL", new Font(Calibri10)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                DTO.Border = 0;
                DTO.PaddingLeft = 15f;
                DTO.MinimumHeight = 20f;
                ...
                DTO = new PdfPCell(new Phrase(dtInvoice.Rows[0]["PreReceived"].ToString() != "0.00"? "Previously Paid":"", new Font(Calibri10)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                DTO.Border = 0;
                DTO.Colspan = 2;
                DTO.MinimumHeight = 20f;
                ...
                DTO = new PdfPCell(new Phrase("PAID AMOUNT", new Font(Calibri10wt)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                //DTO.Border = 0;
                DTO.Colspan = 4;
                DTO.MinimumHeight = 20f;
                ...
                DTO = new PdfPCell(new Phrase("AED " + dtInvoice.Rows[0]["AfterDiscount_GrandTotal"].ToString(), new Font(Calibri14)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                DTO.Border = 0;
                DTO.PaddingLeft = 15f;
                ...
                DTO = new PdfPCell(new Phrase(dtInvoice.Rows[0]["PreReceived"].ToString() != "0.00" ? dtInvoice.Rows[0]["PreReceived"].ToString() : "", new Font(Calibri14)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                DTO.Border = 0;
                DTO.Colspan = 2;
                DTO.MinimumHeight = 30f;
                ...
                DTO = new PdfPCell(new Phrase("AED " + dtInvoice.Rows[0]["Received"].ToString(), new Font(Calibri20wt)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                //DTO.Border = 0;
                DTO.Colspan = 4;
                DTO.PaddingLeft = 15f;
                ...
                DTO = new PdfPCell(new Phrase("Balance", new Font(Calibri10wt)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                DTO.Colspan = 2;
                DTO.MinimumHeight = 20f;
                DTO.PaddingLeft = 15f;
                ...
                DTO = new PdfPCell(new Phrase("AED " + dtInvoice.Rows[0]["Receivable"].ToString(), new Font(Calibri10wt)));
                DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                //DTO.Colspan = 2;
                DTO.MinimumHeight = 20f;
                DTO.VerticalAlignment = PdfPCell.ALIGN_MIDDLE;
                ...
                totalexp.SpacingBefore = 50;
                totalexp.WidthPercentage = 95f;

                // First row - VERIFIED BY (left aligned)
                PdfPCell verifiedCell = new PdfPCell(new Phrase("VERIFIED BY", new Font(Calibri10rd)));
                verifiedCell.Border = 0;
                verifiedCell.MinimumHeight = 20F;
                verifiedCell.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(verifiedCell);

                // Second row - Name (left aligned, below VERIFIED BY)
                PdfPCell nameCell = new PdfPCell(new Phrase(dtInvoice.Rows[0]["Name"].ToString(), new Font(Cambria9)));
                nameCell.Border = 0;
                nameCell.MinimumHeight = 20F;
                nameCell.HorizontalAlignment = Element.ALIGN_LEFT;
                totalexp.AddCell(nameCell);

                document.Add(totalexp);

                // Add the computer generated document note (similar to TaxInvoiceFormat23)
                PdfPTable noteTable = new PdfPTable(1);
                noteTable.DefaultCell.Padding = 4;
                noteTable.SpacingBefore = 10f;
                noteTable.WidthPercentage = 95f;

                // Option 1: Use existing Calibri9 font directly
                PdfPCell noteCell = new PdfPCell(new Phrase("This is a computer generated document and does not need a signature.", Calibri9));
                noteCell.Border = 0;
                noteCell.MinimumHeight = 25F;
