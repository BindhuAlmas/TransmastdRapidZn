...
{
    public partial class DebitShortListNav : System.Web.UI.Page
    {
        ...
        {
            string url = "../Reports/DebitShortList.aspx?FromDate=" + txtFromDate.SelectedDate
        ...
        protected void btn_excelDet_OnClick(object sender, EventArgs e)
        {
            ...
            dtSummary.Columns["Mobile_Num"].ColumnName  = "Contact No";
            if (dtSummary.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=DebitShortlistReport.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(97, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
