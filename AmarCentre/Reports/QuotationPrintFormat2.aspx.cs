...
{
    public partial class QuotationPrintFormat2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            iTextSharp.text.Font arbfntbldH = new iTextSharp.text.Font(bfTimes, 14, Font.NORMAL);
            ...
            //ph1.Add(new Chunk("الفاتورة الأولية", arbfntbldH));

            ph1.Add(new Chunk("Quotation\n", new Font(Font.FontFamily.UNDEFINED, 14, Font.BOLD)));
            ph1.Add(new Chunk("اقتباس", arbfntbldH));
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                float[] widthsdet = new float[] { 4f, 25f, 10f,5f, 8f,8f, 5f, 9f };
                ...
                ph1.Add(new Chunk("مبلغ الغرامة", arbfntbldN));
                DetailH04 = new PdfPCell(ph1);
                DetailH04.HorizontalAlignment = Element.ALIGN_CENTER;
                DetailH04.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                emp_details.AddCell(DetailH04);
                ...
                foreach (DataRow rows in dt_invD.Rows)
                {
                    ...
                    try
                    {
                        ...
                        PdfPCell DT = new PdfPCell(new Phrase(rows["TotalAmount"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                ...
                ph1 = new Phrase();
                ph1.Add(new Chunk("", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLDITALIC)));
                ...
                ph1 = new Phrase();
                ph1.Add(new Chunk("Created by", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                ...
                ph1 = new Phrase();
                ph1.Add(new Chunk(dt_inv.Rows[0]["Name"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                toddddt2wwDD = new PdfPCell(ph1);
                toddddt2wwDD.Border = 0;
                toddddt2wwDD.HorizontalAlignment = Element.ALIGN_CENTER;
                totalexp.AddCell(toddddt2wwDD);
