...
{
    public partial class InvoiceReportCI : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.CustomerInvoiceReportDetail(txt_reg_Frm_date.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txt_reg_Frm_date), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
        ...
        {
            DataSet ds = obj_report.CustomerInvoiceReportDetailExcel(txt_reg_Frm_date.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txt_reg_Frm_date), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=CustomerInvoiceReport.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(84, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
