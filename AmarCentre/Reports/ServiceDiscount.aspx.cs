...
namespace AmarCentre.Reports
{
    public partial class ServiceDiscount : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.serviceDiscountList(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                dtService, dt_cust, 
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.serviceDiscountExcelPdf(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                dtService, dt_cust,  
                drpagent.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpagent.SelectedValue) );
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=ServiceDiscount.xls");
        ...
        protected void btnPdfOnClick(object sender, EventArgs e)
        {
            ...
            string url = "";
            url = "../Reports/ServiceDiscountPdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate + "&ToDate=" + txt_reg_to_date.SelectedDate +
               "&agentId=" + drpagent.SelectedValue ;
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(81, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
