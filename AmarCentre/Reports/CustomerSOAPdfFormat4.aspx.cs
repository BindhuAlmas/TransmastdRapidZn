...
{
    public partial class CustomerSOAPdfFormat4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CustomerSOAPrintFormat4(FromDate, ToDate, CustomerId, PaymentStatus, CompletionStatus);
            ...
            if (dtDetails.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] {  9f, 8f, 12f, 12f, 8f, 8f, 8f };
                ...
                foreach (DataRow rows in dtDetails.Rows)
                {
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["Received"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                        detailCell.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.LEFT_BORDER;
                        detailsTable.AddCell(detailCell);
                    }
                ...
                detailCell = new PdfPCell(new Phrase("Balance", new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailCell.Colspan = 4;
                detailCell.Border = PdfPCell.BOTTOM_BORDER | PdfPCell.LEFT_BORDER;
                detailsTable.AddCell(detailCell);
