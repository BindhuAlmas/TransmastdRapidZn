...
{
    public partial class QuotationPrintFormat5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //ph1.Add(new Chunk("PROFORMA INVOICE", new Font(Font.FontFamily.UNDEFINED, 19, Font.BOLD)));
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                float[] widthsdet = new float[] { 4f, 25f, 5f, 8f, 8f, 9f };
                ...
                ph1 = new Phrase();
                ph1.Add(new Chunk("VAT", new Font(Font.FontFamily.UNDEFINED, 11, Font.BOLD, BaseColor.WHITE)));
