<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="ServiceDiscount.aspx.cs" Inherits="AmarCentre.Reports.ServiceDiscount" %>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    <th style="width: 4%; white-space: nowrap">Sl No.
                                    </th>
                                    <th style="width: 6%">Invoice
                                    </th>
                                    <th style="width: 6%">Date
                                    </th>
