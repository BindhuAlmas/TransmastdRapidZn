...
{
    public partial class TaxInvoiceFormat9 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            iTextSharp.text.Font arbfnt = new iTextSharp.text.Font(bfTimes, 11, Font.NORMAL);
            iTextSharp.text.Font arbsmallbold = new iTextSharp.text.Font(bfTimes, 9, Font.BOLD);
            ...
            PdfPTable intbleleft = new PdfPTable(1);
            intbleleft.DefaultCell.Border = 0;
            intbleleft.WidthPercentage = 98f;
            intbleleft.SpacingAfter = 2f;
            ...
            sub23.Border = PdfPCell.TOP_BORDER;
            sub23.HorizontalAlignment = Element.ALIGN_RIGHT;
            sub23.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            sub23.VerticalAlignment = PdfPCell.ALIGN_BOTTOM;
            intbleleft.AddCell(sub23);
            ...
            if (dt_cust.Rows[0]["Email"].ToString() != "")
            {
                ph1 = new Phrase();
                ...
                intbleleft.AddCell(sub40);
            }

            if (dt_inv.Rows[0]["Subject"].ToString() != "")
            {
                PdfPCell sub1 = new PdfPCell(new Phrase("Subject : "+ dt_inv.Rows[0]["Subject"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                sub1.Border = 0;
                sub1.MinimumHeight = 20f;
                sub1.HorizontalAlignment = Element.ALIGN_LEFT;
                sub1.VerticalAlignment = Element.ALIGN_MIDDLE;
                intbleleft.AddCell(sub1);
            }

            PdfPCell REMhd = new PdfPCell(intbleleft);
            REMhd.Border = PdfPCell.TOP_BORDER;
            Subhead.AddCell(REMhd);

            PdfPTable intbleryt = new PdfPTable(1);
            intbleryt.DefaultCell.Border = 0;
            intbleryt.WidthPercentage = 98f;
            intbleryt.SpacingAfter = 2f;
            ...
            sub04.VerticalAlignment = PdfPCell.ALIGN_BOTTOM;
            intbleryt.AddCell(sub04);
            ...
            sub13.VerticalAlignment = PdfPCell.ALIGN_TOP;
            intbleryt.AddCell(sub13);

            REMhd = new PdfPCell(intbleryt);
            REMhd.Border = PdfPCell.TOP_BORDER;
            Subhead.AddCell(REMhd);
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    float[] widthsdet = new float[] { 5f, 30f, 13f, 9f, 9f, 7f, 7f, 7f, 11f };
