...
{
    public partial class Customerdepositsummary : System.Web.UI.Page
    {
        Report_Bal obj_report = new Report_Bal();

        protected void Page_Load(object sender, EventArgs e)
        {
            DataSet ds = obj_report.CustomerDepositSummaryPdf();
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=Customerdepositsummary.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Customer deposit Summary", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
