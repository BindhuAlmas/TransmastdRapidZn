...
{
    public partial class TaxInvoiceFormat20 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                float[] widthsdet = new float[] { 4f, 25f, 10f, 8f, 6f, 8f, 5f, 9f };
                ...
                PdfPCell DetailH041 = new PdfPCell(ph1);
                DetailH041.HorizontalAlignment = Element.ALIGN_CENTER;
                DetailH041.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
                emp_details.AddCell(DetailH041);
                ...
                foreach (DataRow rows in dt_invD.Rows)
                {
                    ...
                    try
                    {
                        PdfPCell DT = new PdfPCell(new Phrase(Convert.ToDecimal(rows["Amount"]).ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                    ...
                    try
                    {
                        PdfPCell DT = new PdfPCell(new Phrase(rows["Quantity"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                        DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                        emp_details.AddCell(DT);
                    ...
                    try
                    {
                        PdfPCell DT = new PdfPCell(new Phrase(Convert.ToDecimal(rows["Fine"]).ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                        DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                        emp_details.AddCell(DT);
                ...
                totw1wf = new PdfPCell(new Phrase(P.ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                totw1wf.HorizontalAlignment = Element.ALIGN_RIGHT;
                emp_details.AddCell(totw1wf);

                PdfPCell emptyCell = new PdfPCell(new Phrase(""));
                emptyCell.HorizontalAlignment = Element.ALIGN_RIGHT;
                emp_details.AddCell(emptyCell);

                totw1wf = new PdfPCell(new Phrase(F.ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                totw1wf.HorizontalAlignment = Element.ALIGN_RIGHT;
                emp_details.AddCell(totw1wf);
                totw1wf = new PdfPCell(new Phrase(T.ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                totw1wf.HorizontalAlignment = Element.ALIGN_RIGHT;
                emp_details.AddCell(totw1wf);

                totw1wf = new PdfPCell(new Phrase(Tot.ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                totw1wf.HorizontalAlignment = Element.ALIGN_RIGHT;
                emp_details.AddCell(totw1wf);
                ...
                PdfPCell tot2ww = new PdfPCell(new Phrase(Convert.ToDecimal(dt_sum.Rows[0]["Total"]).ToString("###,##0.00"), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                tot2ww.Border = 0;
                ...
                if (dt_inv.Rows[0]["ChargedAmount"].ToString() != "0.00")
                {
                    ...
                    totw1wcc = new PdfPCell(new Phrase(Convert.ToDecimal(dt_inv.Rows[0]["ChargedAmount"]).ToString("###,##0.00"), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    ...
                    totw1wcc = new PdfPCell(new Phrase(GrandtotalFinal.ToString("###,##0.00"), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                    totw1wcc.Border = 0;
                    totw1wcc.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(totw1wcc);
                }
