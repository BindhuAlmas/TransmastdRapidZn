...
{
    public partial class CashReceiptFormat1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sub33a = new PdfPCell(new Phrase("TRN : ", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a.Border = 0;
            sub33a.Colspan = 2;
            sub33a.HorizontalAlignment = Element.ALIGN_RIGHT;
            Subhead.AddCell(sub33a);

             sub24a = new PdfPCell(new Phrase(dt.Rows[0]["InvoiceTRN"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub24a.Border = 0;
            sub24a.HorizontalAlignment = Element.ALIGN_LEFT;
            Subhead.AddCell(sub24a);
            ...
            //sub33a = new PdfPCell(ph1);
            ////sub33a = new PdfPCell(new Phrase("Paid Amount:", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            //sub33a.Border = 0;
            //sub33a.HorizontalAlignment = Element.ALIGN_RIGHT;
            //sub33a.RunDirection = PdfWriter.RUN_DIRECTION_RTL;
            //sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
            ...
            ph1.Add(new Chunk(" / Due Amount", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a = new PdfPCell(ph1);
            ...
            sub33a = new PdfPCell(new Phrase(dt.Rows[0]["Receivable"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a.Border = PdfPCell.TOP_BORDER | PdfPCell.BOTTOM_BORDER;
            sub33a.HorizontalAlignment = Element.ALIGN_RIGHT;
            sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
            sub33a.FixedHeight = SmallRowHeight;
            ...
            //    PdfPCell sub2dre1 = new PdfPCell(new Phrase("   " + dtCustomer.Rows[0]["Remarks"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            //    sub2dre1.Border = 0;
            //    sub2dre1.Colspan = 5;
            ...
            //    Fotservice = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
