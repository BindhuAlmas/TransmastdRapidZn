...
{
    public partial class CustomerDocumentExpiryNav : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.CustomerDocument(txt_reg_Frm_date.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txt_reg_Frm_date), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
                txt_reg_to_date.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txt_reg_to_date), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null, page_number, page_size,
                dtCustomer,
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CustomerDocumentExcel(txt_reg_Frm_date.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txt_reg_Frm_date), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=CustomerDocumentExcel.xls");
        ...
        protected void btn_excelF2_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.CustomerDocumentExcelF2(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
               dtCustomer,drpSponser.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpSponser.SelectedValue),
                 drpagent.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpagent.SelectedValue));
            DataTable dt = ds.Tables[0];
        ...
        protected void btnPdfOnClick(object sender, EventArgs e)
        {
            ...
            string url = "";
            url = "../Reports/CustomerDocumentExpirypdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate + "&ToDate=" + txt_reg_to_date.SelectedDate +
               "&SponserId=" + drpSponser.SelectedValue + "&AgentId=" + drpagent.SelectedValue;
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(82, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
