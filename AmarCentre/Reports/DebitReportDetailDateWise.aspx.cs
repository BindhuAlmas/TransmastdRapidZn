...
{
    public partial class DebitReportDetailDateWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dtgen.Rows[0]["DebitorsReportFormat"].ToString() == "2")
                ds = obj_report.debitorsReportFromat2CustomerDateWise(CustomerId, FromDate, ToDate);
            else
                ds = obj_report.DebitorsReportCustomerDateWise(CustomerId, FromDate, ToDate);
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Debit Report Detail ", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
