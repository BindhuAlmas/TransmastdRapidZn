<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="DebitShortListNav.aspx.cs" Inherits="AmarCentre.Reports.DebitShortListNav" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btn_search" ValidationGroup="Detailed" class="butn" runat="server" OnClick="btnPLDetailed_OnClick"
                                    Text="Print" />
                                      <asp:Button ID="btn_excelDebit" class="butn" runat="server" ValidationGroup="Detailed" Text="Generate Excel"
    ...
    <asp:UpdatePanel ID="Upd_addpanel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
        <ContentTemplate>
         ...
         <Triggers>
            <asp:PostBackTrigger ControlID="btn_excelDebit" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
