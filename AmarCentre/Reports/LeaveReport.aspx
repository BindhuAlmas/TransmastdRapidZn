<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="LeaveReport.aspx.cs" Inherits="AmarCentre.Reports.LeaveReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="Upd_addpanel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
        <ContentTemplate>
            <div style="overflow-x: auto; min-height: 250px; width: auto;">
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px">Name
                                    </th>
                                    <th style="padding: 5px">Leave Type
                                    </th>
                                    <th style="padding: 5px">From
                                    </th>
                                    <th style="padding: 5px; ">To
                                    </th>
                                    <th style="padding: 5px">Reason
                                    </th>
