<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="LoanStatement.aspx.cs" Inherits="AmarCentre.Reports.LoanStatement" %>
            ...
            <asp:Panel ID="pnl_filter" runat="server">
                <div class="animated smallPopUpFilter">
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                Loan <span style="color: Red">&nbsp*</span>
                                <telerik:RadComboBox ID="drpLoan" ClientIDMode="AutoID" Sort="Ascending" EmptyMessage="Search Loan..."
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpLoan"
                                    Display="Dynamic" ValidationGroup="save" ErrorMessage="Required" Style="color: Red"
                                    InitialValue=""></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th id="thReceivable" runat="server" style="padding: 5px">
                                        Receivable
                                    </th>
                                    <th id="thPayable" runat="server" style="padding: 5px">
                                        Payable
                                    </th>
                                    </tr>
                                </thead>
                            ...
                            <td style="padding-left: 3px; white-space: nowrap">
                                ...
                                <td style="padding-left: 3px;">
                                    <asp:Label ID="lblLoanName" runat="server" Text="" TabIndex="-1" ></asp:Label>
                                </td>
                            ...
                            <td id="tdReceivable" runat="server" style="padding-left: 3px; white-space: nowrap;text-align:right">
                                <asp:Label ID="lblReceivable" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
                                    <td id="tdPayable" runat="server" style="padding-left: 3px; white-space: nowrap;text-align:right">
                                <asp:Label ID="lblPayable" runat="server" Text="" TabIndex="-1" ></asp:Label>
                            </td>
                            </tr>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="width:20%;padding: 5px; white-space: nowrap">
                                        Remark
                                    </th>
