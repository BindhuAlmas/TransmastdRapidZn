...
{
    public partial class TaxInvoiceFormat23 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ph1.Add(new Chunk("INVOICE DATE: ", new Font(Cambria9)));
            ...
            TP = new PdfPCell(new Phrase(dtBasic.Rows[0]["InvoiceType"].ToString() == "1"?"TAX INVOICE": "INVOICE", new Font(Roboto14)));
            TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            TP.Border = 0;
            ...
            if (dtBasic.Rows[0]["InvoiceType"].ToString() == "1")
            {
            ...
            if (dtBasic.Rows[0]["InvoiceType"].ToString() == "2")
            {
                ph1.Add(new Chunk(dt_cust.Rows[0]["Name"].ToString() + (dt_cust.Rows[0]["Address"].ToString() != "" ? ("\n\n" + dt_cust.Rows[0]["Address"].ToString()) : "") , new Font(Cambria10)));
            }
            sub00 = new PdfPCell(new Phrase(ph1));
            sub00.Border = 0;
            sub00.MinimumHeight = 30f;
            ...
            if (dtdetail.Rows.Count > 0)
            {
                if (dtBasic.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    if (dtGen.Rows[0]["IsAddRemark"].ToString() != "0" && dtBasic.Rows[0]["Remarks"].ToString() != "")
                    {
                    ...
                    if (dtGen.Rows[0]["IsAddCreatedByInInvoicePrint"].ToString() == "1")
                    {
                ...
                if (dtBasic.Rows[0]["InvoiceType"].ToString() == "2")
                {
                    PdfPTable emp_details = new PdfPTable(5);
                    emp_details.DefaultCell.Padding = 4;
                    float[] widthsdet = new float[] { 30f, 20f, 6f, 12f,  10f };
                    emp_details.SetWidths(widthsdet);
                    emp_details.WidthPercentage = 95f;
                    emp_details.SpacingBefore = 10f;
                    ...
                    DTO = new PdfPCell(new Phrase("", new Font(Calibri10)));
                    DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                    DTO.Border = 0;
                    DTO.PaddingLeft = 15f;
                    DTO.MinimumHeight = 20f;
                    ...
                    DTO = new PdfPCell(new Phrase("", new Font(Calibri14)));
                    DTO.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                    DTO.Border = 0;
                    DTO.Colspan = 2;
                    DTO.MinimumHeight = 30f;
