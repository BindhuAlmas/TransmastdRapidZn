...
{
    public partial class VATStatement : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.VATStatement(txtFromDate.SelectedDate,txtToDate.SelectedDate, page_number, page_size,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblTotalReceivedTax.Text = ds.Tables[1].Rows[0]["TotalReceivedTax"].ToString();
                lblTotalPaidTax.Text = ds.Tables[1].Rows[0]["TotalPaidTax"].ToString();
                lblTotalTaxPayable.Text = ds.Tables[1].Rows[0]["TotalTaxPayable"].ToString();
                TaxableAmount.Text = ds.Tables[1].Rows[0]["TaxableAmount"].ToString();
                TaxableAmountPaid.Text = ds.Tables[1].Rows[0]["TaxableAmountPaid"].ToString();
            ...
            else
            {
                ...
                lblTotalReceivedTax.Text = "";
                lblTotalPaidTax.Text = "";
                lblTotalTaxPayable.Text = TaxableAmount.Text= TaxableAmountPaid.Text = "";
            }
        ...
        {
            DataSet ds = obj_report.VATStatementExcel(txtFromDate.SelectedDate, txtToDate.SelectedDate,
                  drpEmirate.SelectedValue == "" ? (int?)null : Convert.ToInt32(drpEmirate.SelectedValue));
            DataTable dt = ds.Tables[0];
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(43, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
