<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="ReceivableReport.aspx.cs" Inherits="AmarCentre.Reports.ReceivableReport" %>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="padding: 5px; white-space: nowrap; width: 10%">Invoice No
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap; width: 10%">Invoice Amount
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap; width: 10%">Paid Amount
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap; width: 10%">Govt Charge
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap; width: 10%">Service Charge
                                    </th>
                                    <th style="padding: 5px; white-space: nowrap; width: 8%">Tax
                                    </th>
                                    <th style="padding: 5px; width: 10%">Receivable Amount
                                    </th>
                                    <th style="padding: 5px; width: 10%">Govt Charge to Collect
                                    </th>
                                      <th style="padding: 5px; width: 10%">Opening Balance to Collect
                                    </th>
                                    <th style="padding: 5px; width: 10%">Difference in GovtCharge Collected
                                    </th>
                                    <th style="padding: 5px;  width: 7%">Credit Customer
                                    </th>
                                    <th style="padding: 5px;  width: 7%">Is Typing Center
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <asp:Repeater ID="rpt_list" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="padding-left: 3px;text-align: right; white-space: nowrap">
                                                <%#Eval("GovtChargeToCollect")%>
                                            </td>
                                              <td style="padding-left: 3px;text-align: right; white-space: nowrap">
                                                <%#Eval("OBToCollect")%>
                                            </td>
                                            <td style="padding-left: 3px;text-align: right; white-space: nowrap">
                                                <%#Eval("DiffInGovtChargeCollected")%>
                                            </td>
                                            <td style="padding-left: 3px; white-space: nowrap">
                                                <%#Eval("CreditCustomer")%>
                                            </td>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right">
                                        <asp:Label ID="InvoiceAmount" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="PaidAmount" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="GovtCharge" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="ServiceCharge" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="Tax" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="Receivable" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="GovtChargeToCollect" Text="" runat="server"></asp:Label>
                                    </td>
                                     <td style="text-align: right">
                                        <asp:Label ID="OBToCollect" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align: right">
                                        <asp:Label ID="DiffInGovtChargeCollected" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td colspan="2"></td>
                                </tr>
                                <tr>
