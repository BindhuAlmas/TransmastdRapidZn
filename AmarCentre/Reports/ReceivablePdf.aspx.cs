...
{
    public partial class ReceivablePdf : System.Web.UI.Page
    {
        ...
        {
            int Rtype = 1; // receivable type 1 - invoce base, 2- sc base

            try
            {
                Rtype = Convert.ToInt32(Request.QueryString["Rtype"]);
            }
            catch (Exception ex)
            {
                Rtype = 1;
            ...
            if (Rtype == 2)
                ds = obj_report.Get_debitors_ExcelFromat2(1);
            else
                ds = obj_report.Get_debitors_Excel(1);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=DebitReport.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Debtors Report " + (Rtype.ToString() == "2" ? "(Based on Work Completion)" : ""), new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 30f, 20f, 12f, 10f, 10f, 10f, 10f };
                ...
                detailHead = new PdfPCell(new Phrase("Category ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);

                detailHead = new PdfPCell(new Phrase("Credit Customer ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);

                detailHead = new PdfPCell(new Phrase("Is Typing Center ", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["CCategory"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingLeft = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["CreditCustomer"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingRight = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["IsTypingCenter"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingRight = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
                ...
                //dirExpenseCell = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                //dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                //dirExpenseCell.Colspan = 2;
                //dirExpenseCell.PaddingRight = 5f;
                //detailsTable.AddCell(dirExpenseCell);

                dirExpenseCell = new PdfPCell(new Phrase("Total", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.Colspan = 4; // Sl No + Name + Agent + Contact No
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
                ...
                dirExpenseCell = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                dirExpenseCell.Colspan = 3; // Category + Credit Customer + Is Typing Center
                dirExpenseCell.PaddingRight = 5f;
                detailsTable.AddCell(dirExpenseCell);
