...
{
    public partial class ServiceFollowupListpdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.FollowupList(FromDate, ToDate, CustomerId, AgentId, ServiceId);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=ServiceFollowupListpdf.pdf");
            ...
            PdfPCell cell1 = new PdfPCell(new Phrase("FollowupList", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            cell1.Border = 0;
            ...
            if (dtDetails.Rows.Count > 0)
            {
                ...
                float[] widths = new float[] { 5f, 30f, 25f, 15f, 17f, 25f, 25f, 23f };
                ...
                foreach (DataRow rows in dtDetails.Rows)
                {
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["SubService"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        emp_details.AddCell(TP);
                    }
                    catch (Exception eee)
                    ...
                    try
                    {
                        PdfPCell TP = new PdfPCell(new Phrase(rows["DeadlineDate"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        TP.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                        emp_details.AddCell(TP);
                    }
                    catch (Exception eee)
