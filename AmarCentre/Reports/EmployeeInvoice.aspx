<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeInvoice.aspx.cs" Inherits="AmarCentre.Reports.EmployeeInvoice" %>
                        ...
                        <tr>
                            <td>
                              Employee <span style="color: Red">&nbsp*</span>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpEmployee"
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            ...
                            <td style="padding-left: 3px; white-space: nowrap">
                                ...
                                <td style="padding-left: 3px;">
                                    <asp:Label ID="Employee" runat="server" Text="" TabIndex="-1" ></asp:Label>
                                </td>
                            </tr>
                                </tbody>
                            </table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td >
                                     ...
                                     <td >
                                        <asp:Label ID="received" runat="server"></asp:Label>
                                    </td>
                                     <td >
