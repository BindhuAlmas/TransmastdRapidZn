...
{
    public partial class VendorPdfF2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.VendorStatementVersion2PdfFormat2(FromDate, ToDate, VendorId);
            ...
            CustAdv = new PdfPCell(new Phrase("Advance", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            CustAdv.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
            tbl_basic.AddCell(CustAdv);
            CustAdv1 = new PdfPCell(new Phrase(dtEmp.Rows[0]["Receivable"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            CustAdv1.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            tbl_basic.AddCell(CustAdv1);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 9f, 9f, 13f, 19f, 12f, 15f, 9f, 9f };
            ...
            if (dtpayments.Rows.Count > 0)
            {
                ...
                PdfPCell totsss = new PdfPCell(new Phrase("Closing Balance", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
                ...
                PdfPCell totiddssnv = new PdfPCell(new Phrase(dtpaysum.Rows[0]["TBalance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
