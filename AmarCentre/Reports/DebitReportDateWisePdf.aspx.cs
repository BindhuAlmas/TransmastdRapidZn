...
{
    public partial class DebitReportDateWisePdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dtgen.Rows[0]["DebitorsReportFormat"].ToString() == "2")
                ds = obj_report.Debitors_ReportFromat2DateWisePdfExcel(Ctype,FromDate,ToDate);
            else
                ds = obj_report.Debitors_ReportDateWisePdfExcel(Ctype, FromDate, ToDate);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=DebtorsReport.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Debtors Report ", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        dirExpenseCell = new PdfPCell(new Phrase(rows["IsTypingCenters"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                        dirExpenseCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        dirExpenseCell.PaddingRight = 5f;
                        detailsTable.AddCell(dirExpenseCell);
                    }
