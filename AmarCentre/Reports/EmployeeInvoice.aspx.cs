...
{
    public partial class EmployeeInvoice : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.EmployeeInvoiceList(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                Employee.Text = ds.Tables[0].Rows[0]["Employee"].ToString();
                TotalAmount.Text = ds.Tables[2].Rows[0]["InvoiceAmount"].ToString();
                received.Text = ds.Tables[2].Rows[0]["received"].ToString();
                balance.Text = ds.Tables[2].Rows[0]["balance"].ToString();
            }
            else
            {
                lblFromDate.Text = "";
        ...
        {
            DataSet ds = obj_report.EmployeeInvoiceExcel(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=EmployeeInvoice.xls");
        ...
        {
            string url = "../Reports/EmployeeInvoicePdf.aspx?FromDate=" + txt_reg_Frm_date.SelectedDate
        + "&ToDate=" + txt_reg_to_date.SelectedDate + "&EmployeeId=" + Convert.ToInt32(drpEmployee.SelectedValue);
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(113, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
