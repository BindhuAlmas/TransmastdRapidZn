...
{
    public partial class AgentSOA : System.Web.UI.Page
    {
        ...
        protected void drpAgent_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            drpCustomer.Items.Clear();
            DataTable dt = obj_trans.Drp_Customer_FAgent(drpAgent.SelectedValue==""?0:Convert.ToInt32(drpAgent.SelectedValue));
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.AgentSOAStatement(Convert.ToInt32(drpAgent.SelectedValue),dtCustomer, page_number, page_size,
                drpStatus.SelectedValue==""?0:Convert.ToInt32(drpStatus.SelectedValue), txt_reg_Frm_date.SelectedDate,
                txt_reg_to_date.SelectedDate);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblTotal.Text = ds.Tables[1].Rows[0]["Total"].ToString();
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.AgentSOAExcel(Convert.ToInt32(drpAgent.SelectedValue), dtCustomer,
                 drpStatus.SelectedValue == "" ? 0 : Convert.ToInt32(drpStatus.SelectedValue), txt_reg_Frm_date.SelectedDate,
                txt_reg_to_date.SelectedDate);
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=AgentSOA.xls");
        ...
        protected void btnPdfOnClick(object sender, EventArgs e)
        {
            ...
            Session["AgentdtCustomer"] = dtCustomer;
            string url = "../Reports/AgentSOAPdf.aspx?AgentId=" + Convert.ToInt32(drpAgent.SelectedValue)+
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(64, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
