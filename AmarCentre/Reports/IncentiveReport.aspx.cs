...
namespace AmarCentre.Reports
{
    public partial class IncentiveReport : System.Web.UI.Page
    {
        ...
        public void grid_fill(int page_number, int page_size)
        {
            ...
            DataSet ds = obj_report.EmployeeIncentiveStatment(Convert.ToInt32(drp_employee.SelectedValue), txtFromDate.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txtFromDate), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
        ...
        {
            DataSet ds = obj_report.EmployeeIncentiveStatmentExcel(Convert.ToInt32(drp_employee.SelectedValue), txtFromDate.DbSelectedDate != null ? DateTime.ParseExact(CalDate(txtFromDate), "dd/MM/yyyy", CultureInfo.InvariantCulture) : (DateTime?)null,
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Incentive.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(29, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
