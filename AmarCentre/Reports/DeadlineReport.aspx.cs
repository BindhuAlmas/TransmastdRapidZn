...
{
    public partial class DeadlineReport : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.DeadlineList(txt_reg_Frm_date.SelectedDate,   txt_reg_to_date.SelectedDate, page_number, page_size,
        ...
        {
            DataSet ds = obj_report.DeadlineExcel(txt_reg_Frm_date.SelectedDate, txt_reg_to_date.SelectedDate,
                drp_Cust.SelectedValue == "" ? (int?)null : Convert.ToInt32(drp_Cust.SelectedValue), (int?)null, (int?)null);
            DataTable dt = ds.Tables[0];
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=Deadline.xls");
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(112, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
