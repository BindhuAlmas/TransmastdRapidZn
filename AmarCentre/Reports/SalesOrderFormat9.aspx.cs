...
{
    public partial class SalesOrderFormat9 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ph1.Add(new Chunk(" / Pre-invoice No", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            ph1.Add(new Chunk("\n\n", arbfnt));
            ...
            REMhd.Border = 0;// PdfPCell.TOP_BORDER;
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (PrintTerms)
                {
                     terms = new PdfPTable(5);
                    terms.DefaultCell.Padding = 4;
                    widthsTerms = new float[] { 23f, 12f, 15f, 24f, 24f };
                    terms.SetWidths(widthsTerms);
                    terms.SpacingBefore = 10;
                    terms.WidthPercentage = 95f;
