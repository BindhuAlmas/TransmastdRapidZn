...
{
    public partial class PettyCashStatementPdf : System.Web.UI.Page
    {
        Report_Bal obj_report = new Report_Bal();

        protected void Page_Load(object sender, EventArgs e)
        {
            int CashId = Convert.ToInt32(Request.QueryString["CashId"]);
            ...
            DataSet ds = obj_report.PettyCashStatementExcelVersion2(FromDate, ToDate, CashId, UserId);
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=PettyCashStatementPdf.pdf");
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Cash Statement", new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
            HT00.HorizontalAlignment = Element.ALIGN_CENTER;
            HT00.Border = 0;
            headTable.AddCell(HT00);

            HT00 = new PdfPCell(new Phrase("From : " + dtEmp.Rows[0]["From Date"].ToString() + " To : " + dtEmp.Rows[0]["To Date"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
            HT00.HorizontalAlignment = Element.ALIGN_CENTER;
            HT00.Border = 0;
            headTable.AddCell(HT00);
            ...
            sub00 = new PdfPCell(new Phrase("Account : " + dtEmp.Rows[0]["Account Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            /*End of Row*/
            sub00 = new PdfPCell(new Phrase("Opening Balance : " + dtEmp.Rows[0]["Opening Balance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            /*End of Row*/
            sub00 = new PdfPCell(new Phrase("Closing Balance : " + dtEmp.Rows[0]["Closing Balance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub00.Border = 0;
            sub00.HorizontalAlignment = Element.ALIGN_LEFT;
            subHeadTable.AddCell(sub00);
            /*End of Row*/
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                float[] detailsTableWidthsdet = new float[] { 5f, 15f, 25f, 12f,10f, 10f,10f, 10f };
                ...
                detailHead = new PdfPCell(new Phrase("Transaction No", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
                detailHead = new PdfPCell(new Phrase("Done by", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                detailHead.HorizontalAlignment = Element.ALIGN_CENTER;
                detailsTable.AddCell(detailHead);
                ...
                foreach (DataRow rows in dt.Rows)
                {
                    ...
                    try
                    {
                        detailCell = new PdfPCell(new Phrase(rows["TransactionNumber"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.NORMAL)));
                        detailCell.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                        detailsTable.AddCell(detailCell);
                    }
                    catch (Exception ee)
                ...
                detailCell = new PdfPCell(new Phrase(dtEmp.Rows[0]["Total Debit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);

                detailCell = new PdfPCell(new Phrase(dtEmp.Rows[0]["Total Credit"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);

                detailCell = new PdfPCell(new Phrase(dtEmp.Rows[0]["Closing Balance"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD)));
                detailCell.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                detailsTable.AddCell(detailCell);
