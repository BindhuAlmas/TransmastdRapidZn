<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="VATReportF2.aspx.cs" Inherits="AmarCentre.Reports.VATReportF2" %>
                    ...
                    <table class="formTable">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="btn_pdf" class="butn" runat="server" Text="Generate Pdf"
                                ...
                                <tr>
                                    <td colspan="6">
                                     ...
                                     <td style="text-align:right">
                                        <asp:Label ID="lblExcludeVat" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align:right">
                                        <asp:Label ID="lblServiceFee" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align:right">
                                        <asp:Label ID="lblTaxAmount" Text="" runat="server"></asp:Label>
                                    </td>
                                    <td style="text-align:right">
                                        <asp:Label ID="lblIncludeTax" Text="" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
