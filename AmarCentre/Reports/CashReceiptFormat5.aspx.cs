...
{
    public partial class CashReceiptFormat5 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            decimal ReceivedAmount = Convert.ToDecimal(dt.Rows[0]["Amount"]);
            ...
            sub33a = new PdfPCell(new Phrase(Convert.ToDecimal(dt.Rows[0]["Amount"]).ToString("###,##0.00"), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            sub33a.Border = PdfPCell.TOP_BORDER;
            sub33a.Colspan = 2;
            sub33a.HorizontalAlignment = Element.ALIGN_RIGHT;
            sub33a.VerticalAlignment = Element.ALIGN_MIDDLE;
