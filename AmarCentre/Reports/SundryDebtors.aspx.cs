...
{
    public partial class SundryDebtors : System.Web.UI.Page
    {
        ...
        {
            DataSet ds = obj_report.SundryDebitorsReport(page_number, page_size);
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblTotalAmount.Text = ds.Tables[1].Rows[0]["Receivable"].ToString();
                lbladvance.Text = ds.Tables[1].Rows[0]["Advance"].ToString();
        ...
        protected void btn_excel_OnClick(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                HttpContext.Current.Response.AddHeader("content-disposition", "attachment;filename=SundryDebt.xls");
        ...
        {
            string url = "../Reports/SundryDebtPdf.aspx";
        ...
        public void previlage_check()
        {
            try
            {
                ...
                {
                    int val = obj_common.Form_Previlage_Validation(108, Convert.ToInt32(hdn_user_id.Value));
                    if (val == 0)
                    {
                        Response.Redirect("../Landing.aspx");
                    }
