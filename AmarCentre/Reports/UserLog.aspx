<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="UserLog.aspx.cs" Inherits="AmarCentre.Reports.UserLog" %>
                        ...
                        <table class="listTable" style="width: 98%; border: 1px">
                            <thead>
                                <tr style="text-align: center">
                                    ...
                                    <th style="width: 13%;padding: 5px">
                                        Date
                                    </th>
                                    <th style="width: 12%;padding: 5px;">
                                        Transaction
                                    </th>
