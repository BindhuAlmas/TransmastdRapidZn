...
{
    public partial class RVPrintFormat3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet ds = obj_report.ReceiptVoucher_Print(id);
            DataTable dt1 = ds.Tables[0];
            DataTable dt_gen = ds.Tables[1];
            DataTable dtinvoicedet = ds.Tables[2];

            var pgSize = new iTextSharp.text.Rectangle(700, 400);

            //Document document = new Document(pgSize, 20f, 20f, 0f, 0f);
            Document document = new Document(PageSize.A4, 25f, 25f, 0f, 0f);

            HttpContext.Current.Response.ContentType = "application/pdf";
            HttpContext.Current.Response.AddHeader("content-disposition", "inline;filename=ReceiptVoucher.pdf");
            ...
            headrrow12.WidthPercentage = 95f;
            headrrow12.SpacingAfter = 10;
            float[] headrrow12wh = new float[] { 75f, 25f };
            headrrow12.SetWidths(headrrow12wh);

            PdfPCell hdng = new PdfPCell(new Phrase("RECEIPT VOUCHER", new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD)));
            hdng.Border = 0;
            hdng.Colspan = 2;
            ...
            if (dt1.Rows[0]["RVTRN"].ToString() != "")
            {
                headrrow12.AddCell(hdempty);
                hdemptydate = new PdfPCell(new Phrase("TRN : " + dt1.Rows[0]["RVTRN"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
                hdemptydate.Border = 0;
                hdemptydate.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                headrrow12.AddCell(hdemptydate);
            }
            ...
            bool AllowOutstanding = dt1.Rows[0]["CustomerOutstandingAmount"].ToString() != "" ? true : false;
            PdfPTable row1 = new PdfPTable(2);
            row1.DefaultCell.Padding = 4;
            row1.WidthPercentage = 95f;
            row1.SpacingAfter = 10f;
            float[] row1w = new float[] { 40f, 80f };
            row1.SetWidths(row1w);

            PdfPCell row1Cell00 = new PdfPCell(new Phrase("Received with thanks from Mr/Mrs. ", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            row1Cell00.Border = 0;
            row1Cell00.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            row1.AddCell(row1Cell00);


            PdfPCell row1Cell01 = new PdfPCell(new Phrase(dt1.Rows[0]["Name"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD)));
            row1Cell01.Border = 0;
            ...
            PdfPCell row3Cell01 = new PdfPCell(new Phrase(dt1.Rows[0]["PaymentType"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD)));
            row3Cell01.Border = 0;
            ...
            PdfPCell row3Cell03 = new PdfPCell(new Phrase(dt1.Rows[0]["PayDate"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD)));
            row3Cell03.Border = 0;
            ...
            PdfPCell row3Cell05 = new PdfPCell(new Phrase(dt1.Rows[0]["BankName"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 12, Font.BOLD)));
            row3Cell05.Border = 0;
            ...
            PdfPCell row4Cell01 = new PdfPCell(new Phrase(dt1.Rows[0]["IncomeType"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            row4Cell01.Border = 0;
            ...
            if (dtinvoicedet.Rows.Count > 0)
            {
                PdfPTable emp_details = new PdfPTable(2);
                emp_details.DefaultCell.Padding = 4;
                float[] widthsdet = new float[] { 20f, 20f };
                emp_details.SetWidths(widthsdet);
                emp_details.WidthPercentage = 65f;


                PdfPCell sn = new PdfPCell(new Phrase("Invoice Details", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                sn.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
                sn.Border = 0;
                sn.Colspan = 2;
                sn.MinimumHeight = 15f;
                emp_details.AddCell(sn);

                sn = new PdfPCell(new Phrase("Invoice", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                sn.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                sn.MinimumHeight = 15f;
                emp_details.AddCell(sn);

                sn = new PdfPCell(new Phrase("Received Amount", new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.BOLD)));
                sn.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                sn.MinimumHeight = 15f;
                emp_details.AddCell(sn);

                foreach (DataRow r in dtinvoicedet.Rows)
                {
                    sn = new PdfPCell(new Phrase(r["Code"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    sn.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    sn.MinimumHeight = 15f;
                    emp_details.AddCell(sn);

                    sn = new PdfPCell(new Phrase(r["PaidAmount"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 10, Font.NORMAL)));
                    sn.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    sn.MinimumHeight = 15f;
                    emp_details.AddCell(sn);
                }
            ...
            PdfPCell base1cel2 = new PdfPCell(new Phrase("Paid Amount", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            base1cel2.Border = 0;
            base1cel2.Colspan = 2;
            ...
            PdfPCell base1cel4 = new PdfPCell(new Phrase(AllowOutstanding ? "Due Amount" : "", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            base1cel4.Border = 0;
            base1cel4.Colspan = 2;
            ...
            PdfPCell base1cel42 = new PdfPCell(new Phrase(AllowOutstanding ? "AED" : "", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            base1cel42.Border = 0;
            base1cel42.PaddingLeft = 5f;
            base1cel42.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            base1.AddCell(base1cel42);

            PdfPCell base1cel423 = new PdfPCell(new Phrase(AllowOutstanding ? dt1.Rows[0]["CustomerOutstandingAmount"].ToString() : "", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.BOLD)));
            ...
            base1cel233 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            base1cel233.Border = 0;
            base1cel233.PaddingLeft = 5f;
            base1cel233.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            base1.AddCell(base1cel233);
            ...
            //
            base1.AddCell(AllowOutstanding ? dottdln : base1cel1);
            ...
            row5.WidthPercentage = 95f;
            row5.SpacingBefore = 20f;
            float[] row5w = new float[] { 50f, 20f, 30f, 20f, 30f };
            row5.SetWidths(row5w);

            PdfPCell row5Cell00 = new PdfPCell(new Phrase(dt1.Rows[0]["Signature"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            row5Cell00.Border = 0;
            row5Cell00.Colspan = 3;
            row5Cell00.HorizontalAlignment = PdfPCell.ALIGN_LEFT;
            row5.AddCell(row5Cell00);

            PdfPCell row5Cell01 = new PdfPCell(new Phrase("For " + dt_gen.Rows[0]["CompanyName"].ToString(), new Font(Font.FontFamily.TIMES_ROMAN, 11, Font.NORMAL)));
            row5Cell01.Border = 0;
            ...
            if (dt_gen.Rows[0]["PrintFooter"].ToString() != "")
            {
                ...
                string imageURL = Server.MapPath("../UploadedImage/" + dt_gen.Rows[0]["PrintFooter"].ToString());
                iTextSharp.text.Image jpg = iTextSharp.text.Image.GetInstance(new Uri(imageURL));
