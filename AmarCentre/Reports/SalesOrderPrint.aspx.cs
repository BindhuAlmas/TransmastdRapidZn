...
namespace AmarCentre.Reports
{
    public partial class SalesOrderPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ph1.Add(new Chunk("Sales Order\n", new Font(Font.FontFamily.UNDEFINED, 14, Font.BOLD)));
            ph1.Add(new Chunk("طلب المبيعات ", arbfntbldN));
            ...
            PdfPCell sub13 = new PdfPCell(new Phrase("Sales Order No", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
            sub13.Border = 0;
            sub13.Colspan = 2;
            ...
            sub122add.Border = 0;
            //if (dt_inv.Rows[0]["TokenNo"].ToString() == "")
                sub122add.Colspan = 6;
            //else
            //    sub122add.Colspan = 2;
            sub122add.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            //sub1 = new PdfPCell(new Phrase("Agent :", new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
            //sub1.Border = 0;
            //sub1.HorizontalAlignment = Element.ALIGN_LEFT;
            //Subhead.AddCell(sub1);

            //sub12 = new PdfPCell(new Phrase(dt_inv.Rows[0]["AgentName"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
            //sub12.Border = 0;
            //sub12.Colspan = 4;
            //sub12.HorizontalAlignment = Element.ALIGN_LEFT;
            //Subhead.AddCell(sub12);
            ...
            if (dt_invD.Rows.Count > 0)
            {
                ...
                if (dt_inv.Rows[0]["InvoiceType"].ToString() == "1")
                {
                    ...
                    foreach (DataRow rows in dt_invD.Rows)
                    {
                        ...
                        try
                        {
                            ...
                            PdfPCell DT = new PdfPCell(new Phrase(rows["ExpenseFine"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                        ...
                        try
                        {
                            PdfPCell DT = new PdfPCell(new Phrase(rows["SalesOrderDiscount"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                            DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                            emp_details.AddCell(DT);
                        }
                        catch (Exception eee)
                        ...
                        try
                        {
                            ...
                            {
                                PdfPCell DT = new PdfPCell(new Phrase(rows["AfterDiscount_TotalSO"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.NORMAL)));
                                DT.HorizontalAlignment = PdfPCell.ALIGN_RIGHT;
                                emp_details.AddCell(DT);
                            }
                            else
                ...
                else if (dt_inv.Rows[0]["InvoiceType"].ToString() == "2")/*Normal Invoice Type*/
                {
                    ...
                    PdfPCell tot2ww = new PdfPCell(new Phrase((dt_inv.Rows[0]["DisplDiscount"].ToString() == "1" & dt_sum.Rows[0]["AfterDiscount_Total"].ToString() != "") ? dt_sum.Rows[0]["AfterDiscount_Total"].ToString() : dt_sum.Rows[0]["Total"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                    tot2ww.Border = 0;
                ...
                if (dt_inv.Rows[0]["ChargedAmount"].ToString() != "0.00")
                {
                    ...
                    tot2ww = new PdfPCell(new Phrase(dt_inv.Rows[0]["ChargedAmount"].ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                    tot2ww.Border = 0;
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(tot2ww);
                    ...
                    tot2ww = new PdfPCell(new Phrase(GrandtotalFinal.ToString(), new Font(Font.FontFamily.UNDEFINED, 10, Font.BOLD)));
                    tot2ww.Border = 0;
                    tot2ww.HorizontalAlignment = Element.ALIGN_RIGHT;
                    totalexp.AddCell(tot2ww);
                }
