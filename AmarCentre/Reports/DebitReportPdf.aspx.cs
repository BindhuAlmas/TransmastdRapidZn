...
{
    public partial class DebitReportPdf : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (dtgen.Rows[0]["DebitorsReportFormat"].ToString() == "2")
                ds = obj_report.Get_debitors_ExcelFromat2(Ctype);
            else
                ds = obj_report.Get_debitors_Excel(Ctype);
            ...
            PdfPCell HT00 = new PdfPCell(new Phrase("Debtors Report "+(dtgen.Rows[0]["DebitorsReportFormat"].ToString() == "2"?"(Based on Work Completion)":""), new Font(Font.FontFamily.TIMES_ROMAN, 14, Font.BOLD)));
