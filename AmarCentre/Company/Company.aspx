<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="AmarCentre.Company.Company" %>
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    <tr>
                                        ...
                                        <td>
                                          Contact Person
                                            <asp:TextBox ID="txtPerson" CssClass="txt" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                           Contact No<span style="color: Red">&nbsp*</span>
