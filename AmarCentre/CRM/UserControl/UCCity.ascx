<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCCity.ascx.cs" Inherits="AmarCentre.CRM.UserControl.UCCity" %>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtName"
                                                ValidationGroup="savecity" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div>
                                                ...
                                                <asp:Button ID="btnSave" class="butn_save" ValidationGroup="savecity" OnClick="btnSaveOnClick"
