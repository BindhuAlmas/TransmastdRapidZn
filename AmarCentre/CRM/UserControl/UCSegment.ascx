<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCSegment.ascx.cs" Inherits="AmarCentre.CRM.UserControl.UCSegment" %>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtName"
                                                ValidationGroup="saveSegment" Display="Dynamic" ErrorMessage="Required" Style="color: Red"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <div>
                                                ...
                                                <asp:Button ID="btnSave" class="butn_save" ValidationGroup="saveSegment" OnClick="btnSaveOnClick"
