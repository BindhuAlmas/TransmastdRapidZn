<%@ Page Title="" Language="C#" MasterPageFile="~/Layout/Main.Master" AutoEventWireup="true" CodeBehind="StatusMaster.aspx.cs" Inherits="AmarCentre.CRM.StatusMaster" %>
                        ...
                        <asp:UpdatePanel ID="UpdPanelAddInner" runat="server" ChildrenAsTriggers="false"
                            ...
                            <ContentTemplate>
                                ...
                                <table class="formTable">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox runat="server" ID="ChkClosed" Text ="Is Closed" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
