    ...
    <div>
        <asp:UpdatePanel ID="UpdPanelList" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="list_info" style="display: none"></div>
                <table class="listTable">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 13%;">Lead Name</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="10" class="navigationRow">
                                <asp:UpdatePanel ID="UpdPanelNavigation" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:Label ID="lblPageNumber" Style="font-weight: bold; margin-left: 5px; margin-right: 5px; text-align: center;" runat="server"></asp:Label>
            ...
            <ContentTemplate>
                <asp:Panel ID="PanelAdd" Visible="false" runat="server">
                    ...
                    <div class="animated halfPopUp">
                        <asp:UpdatePanel ID="UpdPanelAddInner" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div class="Adding_heading">Lead Creation</div>
                                <table class="formTable">

                                    <%-- ROW 1: Code, Date, Lead Name --%>
                                    <tr>
                                        <td style="width:33%">
                                            Code
                                        ...
                                        <td style="width: 33%">Date <span style="color: Red">&nbsp*</span>
                                            <telerik:RadDatePicker ID="leadDate" runat="server" class="input-boder" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="Calendar3" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                    ...
                                    <%-- ROW 2: Contact Number, Email, Lead Source --%>
                                    <tr>
                                        ...
                                        <td>Email
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please Enter Valid Email ID"
                                                ValidationGroup="save" ControlToValidate="txtEmailId" Style="color: Red"
                                    ...
                                    <%-- ROW 3: Assigned Employee, Priority, Activity --%>
                                    <tr>
                                    ...
                                    <%-- ROW 5: Activity Description + Company Name --%>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 33%">Passport Issue Date
                                            <telerik:RadDatePicker ID="dpPassportIssueDate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="CalPassportIssue" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                            </telerik:RadDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 33%">Passport Expiry Date
                                            <telerik:RadDatePicker ID="dpPassportExpiryDate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="CalPassportExpiry" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                            </telerik:RadDatePicker>
                                        </td>
                                        ...
                                        <td style="width: 33%">Date of Birth
                                            <telerik:RadDatePicker ID="dpDOB" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="CalDOB" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                            </telerik:RadDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        <td style="display:none">Approx. Closing Date <span style="color: Red">&nbsp*</span>
                                            <telerik:RadDatePicker ID="ApprxClosingDate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="Calendar1" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                            </telerik:RadDatePicker>
                                        </td>
                                        <td>Next Follow up Date <span style="color: Red">&nbsp*</span>
                                            <telerik:RadDatePicker ID="Followupdate" runat="server" DateInput-DateFormat="dd/MM/yyyy">
                                                <Calendar runat="server" ID="Calendar2" CssClass="rtlSupport" ShowOtherMonthsDays="False" ShowRowHeaders="False" UseColumnHeadersAsSelectors="False">
                                                    <SpecialDays><telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="#9D9D9D"></telerik:RadCalendarDay></SpecialDays>
                                                </Calendar>
                                            </telerik:RadDatePicker>
                                        ...
                                        <td>Time <span style="color: Red">&nbsp*</span>
                                            <telerik:RadTimePicker ID="radFollowupTime" runat="server"></telerik:RadTimePicker>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:UpdatePanel ID="UpdDocUpload" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <table class="listTable">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rptDocuments" runat="server"
                                                                OnItemDataBound="rptDocumentsOnItemDataBound"
                                                                OnItemCommand="rptDocumentsOnItemCommand">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <telerik:RadComboBox ID="drpDocumentType" Sort="Ascending" Filter="Contains"
                                                                                runat="server" AllowCustomText="true" RenderMode="Lightweight"
                                                                                EmptyMessage="Search Document Type..." ClientIDMode="AutoID"
                                                                                Style="overflow: hidden; width: 91%; border: none!important;"
                                                                                OnClientFocus="OnClientKeyPressing" OnClientBlur="ValidateCombo">
                                                                            </telerik:RadComboBox>
                                                                        </td>
                                                                        <td>
                                                                            <asp:UpdatePanel ID="UpdDocFile" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    ...
                                                                                    <telerik:RadAsyncUpload ID="fuDocFile" MaxFileSize="500000000" runat="server"
                                                                                        MaxFileInputsCount="1" Width="95%"
                                                                                        OnFileUploaded="fuDocFileOnFileUploaded">
                                                                                    </telerik:RadAsyncUpload>
                                                                                    <asp:Label ID="lblFileName" runat="server"
                                                                                        Text='<%#Eval("Filenames") %>'
                                                                                        Visible='<%# Eval("Filenames") != null && Eval("Filenames").ToString() != "" %>'
                                                                                        Style="color: green; font-size: 11px; display:block;">
                                                                                    </asp:Label>
                                                                                </ContentTemplate>
                                                                            </asp:UpdatePanel>
                                                                        </td>
                                                                        <td class="listTableActionButtonDiv">
                                                                            <asp:Button ID="btnDocAdd" runat="server" class="btn_add_new"
                                                                                CommandName="Add" ToolTip="Add Row" />
                                                                            <asp:Button ID="btnDocDelete" runat="server" class="btn_delete"
                                                                                CommandName="Delete" ToolTip="Delete"
                                                                                OnClientClick="javascript: return confirm('Do you really want to Delete.. ?');" />
                                                                            <asp:Button ID="btnDocDownload" runat="server" class="btn_doc_down"
                                                                                CommandName="Download" ToolTip="Download File"
                                                                                Visible='<%# Eval("Filenames") != null && Eval("Filenames").ToString() != "" %>' />
                                                                        </td>
                                                                    </tr>
                                                                </ItemTemplate>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:Button ID="btnanwser" class="butn_save" style="float:right" OnClick="btnanwser_Click" runat="server" Text="Add New Answer" />
                                            <asp:Button ID="Button1" class="butn_save" style="float:right" OnClick="btnQn_Click" runat="server" Text="Add New Question" />
                                                    ...
                                                    <table class="listTable">
                                                        ...
                                                        <tbody>
                                                            <asp:Repeater ID="rptservice" runat="server"
                                                                OnItemDataBound="rptserviceOnItemDataBound"
                                                                ...
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <asp:UpdatePanel ID="UpdSerCategoryDropdown" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                                                <ContentTemplate>
                                                                                    <telerik:RadComboBox ID="drpSerCategory" Sort="Ascending" Filter="Contains" runat="server"
                                                                                        AllowCustomText="true" RenderMode="Lightweight" EmptyMessage="Search ..."
                                                                                        DropDownWidth="300px" ClientIDMode="AutoID"
                                                                                        Style="overflow: hidden; width: 95%; border: none!important;"
                                                                                        OnClientFocus="OnClientKeyPressing" OnClientBlur="ValidateCombo">
                                                                                    </telerik:RadComboBox>
                                                                        ...
                                                                        <td>
                                                                            <asp:Button ID="btn_serDetail_newEntry" runat="server" class="btn_add_new"
                                                                                ValidationGroup="save_serdetail" CommandName="Add" />
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <div>
                                                ...
                                                <asp:Button ID="btnSave" class="butn_save" ValidationGroup="save" OnClick="btnSaveOnClick" runat="server" Text="Save" />
                                                <asp:Button ID="btnCreateQutn" class="butn_save" ValidationGroup="save" OnClick="btnCreateQutn_Click" runat="server" Text="Create Quotation" />
                                                <asp:Button ID="btnMail" class="butn_save" ValidationGroup="save" OnClick="btnMailOnClick" runat="server" Text="Send Mail" />
                                                <asp:Button ID="btnDelete" class="butn_delete" runat="server"
                                                    OnClientClick="javascript : return confirm('Do you really want to Delete.. ?');"
                                                    Visible="false" Text="Delete" OnClick="btnDeleteOnClick" />
                                                <asp:Button ID="btnHistory" class="butn_save" OnClick="btnhistrymainOnClick" runat="server" Text="History" />
                                    ...
                                    <%-- Hidden Fields Row (Campaign, Contact Person, etc.) --%>
                ...
                <div>
                    <div id="div_pop2" class="messageAlert div_pop animated" style="display: none" runat="server">
                        ...
                        <div><asp:Label ID="lbl_msg" runat="server" class="messageLabel"></asp:Label></div>
                    </div>
                </div>

                <%-- History Panel --%>
                <asp:UpdatePanel ID="updHistoryMain" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                    <Triggers><asp:PostBackTrigger ControlID="btnexcel_export" /></Triggers>
                    <ContentTemplate>
                        <asp:Panel ID="pnlHistory" runat="server" Visible="false">
                            <div class="popupBackground"></div>
                            <div class="animated halfPopUp" style="width: 80%">
                                <div class="Adding_heading">History</div>
                                <table style="padding: 20px; width: 100%">
                                    <tr>
                                        <td colspan="4">
                                            <div style="float:right">
                                                <asp:Button ID="btnexcel_export" runat="server" class="btn_excel" ToolTip="Export to Excel" OnClick="btn_excelhis_OnClick" />
                                                <span style="color: Red">&nbsp;&nbsp;</span>
                                                <asp:Button ID="Button2" runat="server" class="btn_print" ToolTip="Export to pdf" OnClick="btn_pdfhis_OnClick" />
                                                <span style="color: Red">&nbsp;&nbsp;</span>
                                            </div>
                                                        ...
                                                        <table class="listTable">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="text-align: center; width: 15%">Customer Response</th>
                                                                    <th style="text-align: center; width: 13%">Remark</th>
                                                                    <th style="text-align: center; width: 7%">Status</th>
                                                                    <th style="text-align: center; width: 11%">Next Followup Date</th>
                                                                    <th style="text-align: center; width: 10%">Done By</th>
                                                                </tr>
                                                            </thead>
                                                                ...
                                                                <td colspan="7" class="navigationRow">
                                                                    <asp:UpdatePanel ID="upd_his_nav" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                                        <ContentTemplate>
                                                                            ...
                                                                            <asp:Label ID="lbl_page_number1" Style="font-weight: bold; margin-left: 5px; margin-right: 5px; text-align: center;" runat="server"></asp:Label>
                ...
                <asp:Panel ID="pnlupload" Visible="false" runat="server">
                    ...
                    <div class="animated largePopUp">
                        <asp:UpdatePanel ID="upduploadexcel" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                            <ContentTemplate>
                                <div class="Adding_heading">Upload Excel</div>
                                <table class="formTable">
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="updleadFile" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:Button ID="Btndwnformat" class="butn_save" OnClick="Btndwnformat_Click" runat="server" Text="Download Excel Format" />
                                                    <asp:HiddenField ID="hdnleadFile" runat="server" />
                                                    <asp:HiddenField ID="hdnleadfileExtension" runat="server" />
                                                </ContentTemplate>
                                                <Triggers><asp:PostBackTrigger ControlID="Btndwnformat" /></Triggers>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="updleadFileList" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                            ...
                                                            <asp:Repeater ID="rptuploaddetail" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        ...
                                                                        <td><%#Eval("LeadSource")%><asp:HiddenField ID="hdnLeadSourceId" runat="server" Value='<%#Eval("LeadSourceId")%>' /></td>
                                                    ...
                                                    <asp:Button ID="btnverfy" class="butn_save" OnClick="btnverfy_Click" runat="server" Text="Verified and Save" />
                                                    <asp:Button ID="btnverfyclose" class="butn_save" OnClick="btnverfyclose_Click" runat="server" Text="Close" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
